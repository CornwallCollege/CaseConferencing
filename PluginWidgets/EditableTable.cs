    ...
    public partial class EditableTable {
...
#if !JAVA
        private const string RowControlIdAppendedViewStateKey = "RowControlIdAppended";
#endif
        ...
        public override void OnRender() {
            if (databound || !AppInfo.GetAppInfo().OsContext.IsAjaxRequest) {
                ...
                lastRow = Repeater.Rows.LastOrDefault();
                if (lastRow == null || GetPropertyValue<string>(RowControlIdAppendedViewStateKey) != lastRow.ID) {
#endif
...
#if !JAVA
                    StorePropertyValue(RowControlIdAppendedViewStateKey, Repeater.Rows.Last().ID);
                }
#endif
