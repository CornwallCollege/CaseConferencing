...
namespace ssCaseConferencing.Flows.FlowStaffView {
	public abstract class WBlkStaffView_Sort: OSUserControl, IWebScreen, INegotiateTabIndexes, IAjaxNotifyEvent {
		...
		public static void GetCss(TextWriter writer, bool inline, HashSet<string> visited) {
			string blockId = "CaseConferencing.K8WHKzx76TkqI4xmNGbqrRg";
		...
		public ObjectKey Key {
			get {
				return ObjectKey.Parse("8WHKzx76TkqI4xmNGbqrRg"); 
			}
		}
		...
		public string cnt_Container3_setInlineAttributes(object sender, System.EventArgs e) {
			...
			try {
				heContext.CurrentESpaceId = ssCaseConferencing.Global.eSpaceId;
				{
					string newstyledef;
					string oldstyledef;
					newstyledef = (((("position:absolute;top:" +inParamTop) + "px;left:") +inParamLeft) + "px");
		...
		public bool if_wt_If9() {
			...
			if_wt_If9_evalResult = (((RCStaffView_SearchStaffView_FilterRecord) Global.App.OsContext.Session["CaseConferencing.StaffView_Search"]).ssSTStaffView_Filter.ssOrderBy==inParamColumn);
			return if_wt_If9_evalResult;
		}
		...
		public bool if_wt_If7() {
			...
			if_wt_If7_evalResult = (((RCStaffView_SearchStaffView_FilterRecord) Global.App.OsContext.Session["CaseConferencing.StaffView_Search"]).ssSTStaffView_Filter.ssOrderDirection== "ASC");
			return if_wt_If7_evalResult;
		}
		...
		public void RichWidgets_webBlck_WebBlockInstance6_onDataBinding(object sender, System.EventArgs e) {
			...
			try {
				...
				widget.inParamName = ENIconNameEntity.GetRecordByKey(ObjectKey.Parse("gTBCsb7umkmMEmTkkquJDQ")).ssClass;
				widget.inParamSize = "";
			} finally {
				heContext.CurrentESpaceId = oldCurrentESpaceId;
			}
		...
		public void RichWidgets_webBlck_WebBlockInstance1_onDataBinding(object sender, System.EventArgs e) {
			...
			try {
				heContext.CurrentESpaceId = ssCaseConferencing.Global.eSpaceId;
				proxy_CaseConferencing_RichWidgets.Flows.FlowRichWidgets.WBlkIcon widget = (proxy_CaseConferencing_RichWidgets.Flows.FlowRichWidgets.WBlkIcon) sender;
				widget.inParamName = ENIconNameEntity.GetRecordByKey(ObjectKey.Parse("GSs_N8ECyEuSXIlFjqLQPg")).ssClass;
				widget.inParamSize = "";
			} finally {
				heContext.CurrentESpaceId = oldCurrentESpaceId;
			}
		...
		public override string WebBlockIdentifier {
			get {
				return "CaseConferencing.K8WHKzx76TkqI4xmNGbqrRg";
			}
		}
	}
