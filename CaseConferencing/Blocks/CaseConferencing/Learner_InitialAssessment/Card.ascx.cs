...
namespace ssCaseConferencing.Flows.FlowLearner_InitialAssessment {
	public abstract class WBlkCard: OSUserControl, IWebScreen, INegotiateTabIndexes, IAjaxNotifyEvent {
		...
		/// </summary>
		/// <summary>
		/// Screen Input Parameter inParamIsSmall. Description:
		/// </summary>
		public bool inParamIsSmall = false;
		...
		public OutSystems.HubEdition.WebWidgets.Container wtAction;
		public ITemplate phAction {
			get; set; 
		}
		...
		override protected void OnInit(EventArgs e) {
			...
			if (phAction != null) {
				phAction.InstantiateIn(wtAction); 
			}
		}
		...
		public static void GetCss(TextWriter writer, bool inline, HashSet<string> visited) {
			string blockId = "CaseConferencing.KPtyfwhaVV0y1YlRS5LAjmQ";
		...
		public ObjectKey Key {
			get {
				return ObjectKey.Parse("PtyfwhaVV0y1YlRS5LAjmQ"); 
			}
		}
		...
		public string cntInitialAssessment_setInlineAttributes(object sender, System.EventArgs e) {
			...
			try {
				heContext.CurrentESpaceId = ssCaseConferencing.Global.eSpaceId;
				((WebControl) sender).CssClass = ((inParamIsSmall) ?("SelectedCardItemSmall"):("SelectedCardItem"));
		...
		public string cnt_Container2_setInlineAttributes(object sender, System.EventArgs e) {
			...
			try {
				heContext.CurrentESpaceId = ssCaseConferencing.Global.eSpaceId;
				{
					string newstyledef;
					string oldstyledef;
					newstyledef = "position:absolute;right:0px;margin-top:-20px";
					oldstyledef = ((IAttributeAccessor) sender).GetAttribute("style");
					if (oldstyledef != null) {
						if (!oldstyledef.TrimEnd().EndsWith(";")) newstyledef = ";" + newstyledef;
						((IAttributeAccessor) sender).SetAttribute("style", oldstyledef + newstyledef.ToString());
		...
		public void wtAction_onDataBinding(object sender, System.EventArgs e) {
			int oldCurrentESpaceId = heContext.CurrentESpaceId;
			try {
				heContext.CurrentESpaceId = ssCaseConferencing.Global.eSpaceId;
				wtAction_setInlineAttributes(sender, e);
			} finally {
				heContext.CurrentESpaceId = oldCurrentESpaceId;
			}
		}
		public string wtAction_setInlineAttributes(object sender, System.EventArgs e) {
			int oldCurrentESpaceId = heContext.CurrentESpaceId;
			try {
				heContext.CurrentESpaceId = ssCaseConferencing.Global.eSpaceId;
				return "";
		...
		public override string WebBlockIdentifier {
			get {
				return "CaseConferencing.KPtyfwhaVV0y1YlRS5LAjmQ";
			}
		}
	}
