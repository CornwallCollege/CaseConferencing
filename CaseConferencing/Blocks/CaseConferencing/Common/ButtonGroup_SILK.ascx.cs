...
namespace ssCaseConferencing.Flows.FlowCommon {
	public abstract class WBlkButtonGroup_SILK: OSUserControl, IWebScreen, INegotiateTabIndexes, IAjaxNotifyEvent {
		...
		/// </summary>
		/// <summary>
		/// Variable SilkUIFramework_wt_WebBlockInstance3
		/// </summary>
		protected proxy_CaseConferencing_SilkUIFramework.Flows.FlowDevelopment.WBlkJS SilkUIFramework_wt_WebBlockInstance3;
		...
		private void InitializeComponent() {
			SilkUIFramework_wt_WebBlockInstance3 = (proxy_CaseConferencing_SilkUIFramework.Flows.FlowDevelopment.WBlkJS) FindControl("SilkUIFramework_wt_WebBlockInstance3");
		...
		public static void GetCss(TextWriter writer, bool inline, HashSet<string> visited) {
			string blockId = "CaseConferencing.K5tUHmrdnGUGm6Boh64E1fQ";
		...
		private static void InnerGetCss(TextWriter writer, bool inline, HashSet<string> visited) {
			proxy_CaseConferencing_SilkUIFramework.Flows.FlowDevelopment.WBlkJS.GetCss(writer, inline, visited);
		}
		...
		public ObjectKey Key {
			get {
				return ObjectKey.Parse("5tUHmrdnGUGm6Boh64E1fQ"); 
			}
		}
		...
		public void SilkUIFramework_webBlck_WebBlockInstance3_onDataBinding(object sender, System.EventArgs e) {
			int oldCurrentESpaceId = heContext.CurrentESpaceId;
			try {
				heContext.CurrentESpaceId = ssCaseConferencing.Global.eSpaceId;
				proxy_CaseConferencing_SilkUIFramework.Flows.FlowDevelopment.WBlkJS widget = (proxy_CaseConferencing_SilkUIFramework.Flows.FlowDevelopment.WBlkJS) sender;
		...
		public override Control FindControl(string id) {
			if (id == "wt_Text2") {
				return SilkUIFramework_wt_WebBlockInstance3.wtDescription.FindControl("wt_Text2");
			}
		...
		public override string WebBlockIdentifier {
			get {
				return "CaseConferencing.K5tUHmrdnGUGm6Boh64E1fQ";
			}
		}
