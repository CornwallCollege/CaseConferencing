...
Calendar._TT["PREV_YEAR"] = "上一年(长按显示列表)";
Calendar._TT["PREV_MONTH"] = "上一个月(长按显示列表)";
Calendar._TT["GO_TODAY"] = "返回今天";
Calendar._TT["NEXT_MONTH"] = "下一个月(长按显示列表)";
Calendar._TT["NEXT_YEAR"] = "下一年(长按显示列表)";
...
Calendar._TT["DAY_FIRST"] = "第一列显示 %s";
...
Calendar._TT["TIME_PART"] = "（Shift-）点击/拖拽来选择时间";
// date formats
