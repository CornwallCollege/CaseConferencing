...
Calendar._TT["PREV_YEAR"] = "前年（長押しでリスト表示）";
Calendar._TT["PREV_MONTH"] = "前月（長押しでリスト表示）";
Calendar._TT["GO_TODAY"] = "今日へ";
Calendar._TT["NEXT_MONTH"] = "翌月（長押しでリスト表示）";
Calendar._TT["NEXT_YEAR"] = "翌年（長押しでリスト表示）";
Calendar._TT["SEL_DATE"] = "日付選択";
Calendar._TT["DRAG_TO_MOVE"] = "移動";
...
Calendar._TT["TIME_PART"] = "（Shift-）クリック／ドラッグして時刻変更";
// date formats
