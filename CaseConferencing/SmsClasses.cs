...
namespace ssCaseConferencing {
	...
	public abstract class SmsNode : ISerializable, IScreen, IVarsBag {
		...
		public SmsNode () {
			...
			MTMsg.TenantId = AppInfo.GetAppInfo().Tenant.Id;
			MTMsg.TenantPath = AppInfo.GetAppInfo().TenantPath;
			MTMsg.eSpaceId = AppInfo.GetAppInfo().eSpaceId;
			MTMsg.UserId = AppInfo.GetAppInfo().OsContext.Session.UserId;
		}
