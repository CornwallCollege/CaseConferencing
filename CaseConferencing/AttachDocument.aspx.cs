...
namespace ssCaseConferencing.Flows.FlowSafeguarding {
	...
	public class ScrnAttachDocument: OSPageViewStateCompressed, IWebScreen, INegotiateTabIndexes, IBookmarkableURL {


		public ScrnAttachDocument(): base(CaseConferencing_Properties.QuirksMode) {
		}
		...
		/// <summary>
		/// Variable <code>varLcSafeguardingDocument</code> that represents the Service Studio local variable
		///  <code>SafeguardingDocument</code> <p>Description: </p>
		/// </summary>
		RCSafeguardingDocumentsRecord varLcSafeguardingDocument = new RCSafeguardingDocumentsRecord(null);

		/// <summary>
		/// Variable <code>varLcSafeguardingDocumentBinary</code> that represents the Service Studio local
		///  variable <code>SafeguardingDocumentBinary</code> <p>Description: </p>
		/// </summary>
		RCSafeguardingDocumentsBinaryRecord varLcSafeguardingDocumentBinary = new RCSafeguardingDocumentsBinaryRecord(null);
		...
		protected string GetRequestInfoJavaScript() {
			return GetRequestInfoJavaScript("+h2yMnWoBUC+RbtdjckmrQ", "AttachDocument");
		}
		...
		protected string GetHeadTopJavaScript() {
			return GetInjectedCode(CodeInjectionFactory.Locations.HeadTop, "+h2yMnWoBUC+RbtdjckmrQ", "AttachDocument");
		}

		protected string GetHeadBottomJavaScript() {
			return GetInjectedCode(CodeInjectionFactory.Locations.HeadBottom, "+h2yMnWoBUC+RbtdjckmrQ", "AttachDocument");
		}

		protected string GetBodyTopJavaScript() {
			return GetInjectedCode(CodeInjectionFactory.Locations.BodyTop, "+h2yMnWoBUC+RbtdjckmrQ", "AttachDocument");
		}

		protected string GetBodyBottomJavaScript() {
			return GetInjectedCode(CodeInjectionFactory.Locations.BodyBottom, "+h2yMnWoBUC+RbtdjckmrQ", "AttachDocument");
		}
		...
		protected void InitializeUrls() {
			...
			if (Request.AppRelativeCurrentExecutionFilePath.IndexOf('/', 2) == -1) {
				...
				actionUrl += AppUtils.GetPageName(heContext, Global.eSpaceId, "AttachDocument", parameters,/*useParamsOnlyIfNeededForRule*/ true);
			}
			bookmarkableUrl += AppUtils.GetPageName(heContext, Global.eSpaceId, "AttachDocument", parameters,/*useParamsOnlyIfNeededForRule*/ false);
		...
		public override Control FindControl(string id) {
			if (id == "RichWidgets_wt_WebBlockInstance6") {
				return wt_WebBlockInstance4.wtTitle.FindControl("RichWidgets_wt_WebBlockInstance6");
			}
			if (id == "wt_Text7") {
				return wt_WebBlockInstance4.wtTitle.FindControl("wt_Text7");
			}
			if (id == "wt_Container3") {
				return wt_WebBlockInstance4.wtContent.FindControl("wt_Container3");
			}
			if (id == "wt_Container8") {
				return wt_WebBlockInstance4.wtContent.FindControl("wt_Container8");
			}
			if (id == "wtFileToUpload") {
				return wt_WebBlockInstance4.wtContent.FindControl("wtFileToUpload");
			}
			if (id == "wt_Container2") {
				return wt_WebBlockInstance4.wtContent.FindControl("wt_Container2");
			}
			if (id == "wt_Button9") {
				return wt_WebBlockInstance4.wtContent.FindControl("wt_Button9");
			}
			if (id == "wt_Button1") {
				return wt_WebBlockInstance4.wtContent.FindControl("wt_Button1");
			}
		...
		private void Page_Load(object sender, System.EventArgs e) {
			...
			if (!IsPostBack) {
				ArrayList screenParameters = (ArrayList) Global.App.OsContext.Session["CaseConferencing._ScreenParameters_AttachDocument"];
				...
				if ((screenParametersKey == null || this.Key.Equals(ObjectKey.Parse(Convert.ToString(screenParametersKey)))) && screenParameters != null) {
					try {
						...
						Global.App.OsContext.Session["CaseConferencing._ScreenParameters_AttachDocument"] = null;
			...
			if (!IsPostBack) {
				...
				Title = "AttachDocument"; Page.DataBind();
				if (!heContext.AppInfo.SelectiveLoggingEnabled || heContext.AppInfo.Properties.AllowLogging) {
					ScreenLog.StaticWrite(heContext.StartInstant, (int) ((TimeSpan) (DateTime.Now-heContext.StartInstant)).TotalMilliseconds, "AttachDocument", heContext.Session.SessionID, heContext.AppInfo.eSpaceId, heContext.AppInfo.Tenant.Id, heContext.Session.UserId, (string) heContext.Session["MSISDN"], "WEB", "Screen", Environment.MachineName, RuntimePlatformUtils.GetViewstateSize(), RuntimePlatformUtils.GetRetrievedSessionSize(), RuntimePlatformUtils.GetRetrievedSessionRequests());
				}
			} else {
				if (!Request.IsSecureConnection) throw new Exception("HTTPS connection required for this screen");
				FetchViewState();
		...
		public ObjectKey Key {
			get {
				return ObjectKey.Parse("+h2yMnWoBUC+RbtdjckmrQ"); 
			}
		}
		...
		public class lcvOk: VarsBag {
			public int resCreateSafeguardingDocuments_outParamId = 0;

			public int resCreateSafeguardingDocumentsBinary_outParamId = 0;
		...
		private bool CommandOk(HeContext heContext) {
			...
			try {
				varLcSafeguardingDocument.ssENSafeguardingDocuments.ssSafeguardingIssue = inParamSafeguardingIssueID; // SafeguardingDocument.SafeguardingDocuments.SafeguardingIssue = SafeguardingIssueID
				varLcSafeguardingDocument.ssENSafeguardingDocuments.ssDocumentName = Rt_wtFileToUpload.Filename; // SafeguardingDocument.SafeguardingDocuments.DocumentName = FileToUpload.Filename
				varLcSafeguardingDocument.ssENSafeguardingDocuments.ssDocumentType = Rt_wtFileToUpload.Type; // SafeguardingDocument.SafeguardingDocuments.DocumentType = FileToUpload.Type
				// CreateSafeguardingDocuments
				ExtendedActions.CreateSafeguardingDocuments(heContext, varLcSafeguardingDocument, out localVars.resCreateSafeguardingDocuments_outParamId);
				varLcSafeguardingDocumentBinary.ssENSafeguardingDocumentsBinary.ssSafeguardingDocuments = localVars.resCreateSafeguardingDocuments_outParamId; // SafeguardingDocumentBinary.SafeguardingDocumentsBinary.SafeguardingDocuments = CreateSafeguardingDocuments.Id
				varLcSafeguardingDocumentBinary.ssENSafeguardingDocumentsBinary.ssDocumentBinary = Rt_wtFileToUpload.Content; // SafeguardingDocumentBinary.SafeguardingDocumentsBinary.DocumentBinary = FileToUpload.Content
				// CreateSafeguardingDocumentsBinary
				ExtendedActions.CreateSafeguardingDocumentsBinary(heContext, varLcSafeguardingDocumentBinary, out localVars.resCreateSafeguardingDocumentsBinary_outParamId);
				// Popup_Editor_Notify
				Actions.ActionPopup_Editor_Notify(heContext, "File Added");
				// Popup_Editor_Close
				Actions.ActionPopup_Editor_Close(heContext);
				// Update Screen
				return true;
		...
		public void doAJAXRefreshScreen(HeContext heContext) {
			...
			try {
				...
				Page.DataBind();
				if (!heContext.AppInfo.SelectiveLoggingEnabled || heContext.AppInfo.Properties.AllowLogging) {
					ScreenLog.StaticWrite(heContext.StartInstant, (int) ((TimeSpan) (DateTime.Now-heContext.StartInstant)).TotalMilliseconds, "AttachDocument", heContext.Session.SessionID, heContext.AppInfo.eSpaceId, heContext.AppInfo.Tenant.Id, heContext.Session.UserId, (string) heContext.Session["MSISDN"], "WEB", "Ajax", Environment.MachineName, RuntimePlatformUtils.GetViewstateSize(), RuntimePlatformUtils.GetRetrievedSessionSize(), RuntimePlatformUtils.GetRetrievedSessionRequests());
				}
			} finally {
				heContext.CurrentESpaceId = oldCurrentESpaceId;
			}
		...
		protected override void StoreViewState() {
			...
			ViewStateAttributes.SetInViewState("varLcSafeguardingDocument_ssENSafeguardingDocuments_ssId", varLcSafeguardingDocument.ssENSafeguardingDocuments.ssId, 0);
			ViewStateAttributes.SetInViewState("varLcSafeguardingDocument_ssENSafeguardingDocuments_ChangedAttributes", BitArrayUtils.EncodeBitArray((BitArray) (BitArrayUtils.SafeAnd(varLcSafeguardingDocument.ssENSafeguardingDocuments.ChangedAttributes, new BitArray(new bool[] {
				true, false, false, false
			}
			)))), null);
			ViewStateAttributes.SetInViewState("varLcSafeguardingDocument_ssENSafeguardingDocuments_OptimizedAttributes", BitArrayUtils.EncodeBitArray((BitArray) (BitArrayUtils.SafeOr(varLcSafeguardingDocument.ssENSafeguardingDocuments.OptimizedAttributes, new BitArray(new bool[] {
				false, true, true, true
			}
			)))), null);
			ViewStateAttributes.SetInViewState("varLcSafeguardingDocumentBinary_ssENSafeguardingDocumentsBinary_ssId", varLcSafeguardingDocumentBinary.ssENSafeguardingDocumentsBinary.ssId, 0);
			ViewStateAttributes.SetInViewState("varLcSafeguardingDocumentBinary_ssENSafeguardingDocumentsBinary_ChangedAttributes", BitArrayUtils.EncodeBitArray((BitArray) (BitArrayUtils.SafeAnd(varLcSafeguardingDocumentBinary.ssENSafeguardingDocumentsBinary.ChangedAttributes, new BitArray(new bool[] {
				true, false, false
			}
			)))), null);
			ViewStateAttributes.SetInViewState("varLcSafeguardingDocumentBinary_ssENSafeguardingDocumentsBinary_OptimizedAttributes", BitArrayUtils.EncodeBitArray((BitArray) (BitArrayUtils.SafeOr(varLcSafeguardingDocumentBinary.ssENSafeguardingDocumentsBinary.OptimizedAttributes, new BitArray(new bool[] {
				false, true, true
			}
			)))), null);
		}
		...
		protected override void FetchViewState() {
			...
			try {
				...
				varLcSafeguardingDocument.ssENSafeguardingDocuments.ssId = (int) ViewStateAttributes.GetFromViewState("varLcSafeguardingDocument_ssENSafeguardingDocuments_ssId", 0);
				varLcSafeguardingDocument.ssENSafeguardingDocuments.ChangedAttributes = BitArrayUtils.DecodeBitArray(ViewStateAttributes.GetFromViewState("varLcSafeguardingDocument_ssENSafeguardingDocuments_ChangedAttributes", null));
				varLcSafeguardingDocument.ssENSafeguardingDocuments.OptimizedAttributes = BitArrayUtils.DecodeBitArray(ViewStateAttributes.GetFromViewState("varLcSafeguardingDocument_ssENSafeguardingDocuments_OptimizedAttributes", null));
				varLcSafeguardingDocumentBinary.ssENSafeguardingDocumentsBinary.ssId = (int) ViewStateAttributes.GetFromViewState("varLcSafeguardingDocumentBinary_ssENSafeguardingDocumentsBinary_ssId", 0);
				varLcSafeguardingDocumentBinary.ssENSafeguardingDocumentsBinary.ChangedAttributes = BitArrayUtils.DecodeBitArray(ViewStateAttributes.GetFromViewState("varLcSafeguardingDocumentBinary_ssENSafeguardingDocumentsBinary_ChangedAttributes", null));
				varLcSafeguardingDocumentBinary.ssENSafeguardingDocumentsBinary.OptimizedAttributes = BitArrayUtils.DecodeBitArray(ViewStateAttributes.GetFromViewState("varLcSafeguardingDocumentBinary_ssENSafeguardingDocumentsBinary_OptimizedAttributes", null));
			} catch (Exception e) {
