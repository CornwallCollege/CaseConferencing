...
namespace ssCaseConferencing {
	...
	public class Global: System.Web.HttpApplication {
		...
		public const int eSpaceId = 10;

		private static object databaseResourceManagerLock = new object();
		private static object embeddedResourceManagerLock = new object();
		private static IResourceManager databaseResourceManager;
		private static IResourceManager embeddedResourceManager;
		...
		protected string RequestPtaName {
			get {
				return AppInfo.GetRequestPtaName(Context.Request);
			}
		}
		...
		static Global() {
			// Log
			OutSystems.RuntimeCommon.Log.EventLogger.SetUp(OutSystems.RuntimeCommon.Log.EventLogger.DefaultSource, "Message generated by eSpace CaseConferencing.");
			// Late load
		...
		protected static object GetSessionDefault(string varName) {
			if (varName == "CaseConferencing.StudentRAG_List_SearchKeyword")
			return "";
			if (varName == "UserName")
			return "";
			if (varName == "CaseConferencing.Reward_List_SearchKeyword")
			return "";
			if (varName == "CaseConferencing.SafeguardingIssue_List_SearchKeyword3")
			return "";
			if (varName == "CaseConferencing.CCSession_List_SearchKeyword")
			return "";
			if (varName == "CaseConferencing.CauseOfConcern_List_SearchKeyword")
			return "";
			if (varName == "CaseConferencing.RewardReason_List_SearchKeyword")
			return "";
			if (varName == "CaseConferencing.StaffViewListPosition")
			return 0;
			if (varName == "CaseConferencing.StaffStudentFavourite_List_SearchKeyword")
			return "";
			if (varName == "CaseConferencing.Update_List_SearchKeyword3")
			return "";
			if (varName == "CaseConferencing.AutoCompleteBank_List_SearchKeyword")
			return "";
			if (varName == "TerminalType")
			return "";
			if (varName == "CaseConferencing.SafeguardingIssue_List_SearchKeyword")
			return "";
			if (varName == "CaseConferencing.CaseConferecingSession")
			return new RCCaseConferencingSession_FilterRecord(null);
			if (varName == "CaseConferencing.CauseOfConcernReason_List_SearchKeyword")
			return "";
			if (varName == "CaseConferencing.Update_List_SearchKeyword2")
			return "";
			if (varName == "MSISDN")
			return "";
			...
			if (varName == "UserID")
			return 0;
			if (varName == "CaseConferencing.StaffView_Search")
			return new RCStaffView_SearchStaffView_FilterRecord(null);
			if (varName == "CaseConferencing.ClearLearnerPagination")
			return false;
			if (varName == "CaseConferencing.SearchCourse")
			return "";
			if (varName == "CaseConferencing.SafeguardingIssue_List_SearchKeyword2")
			return "";
			if (varName == "CaseConferencing.Update_List_SearchKeyword")
			return "";
			if (varName == "CaseConferencing.StaffViewMaxRecords")
			return 20;
			if (varName == "CaseConferencing.yPos")
			return 0;
			if (varName == "CaseConferencing.CourseListFilter")
			return new RCCourseListFilterRecord(null);
		...
		private void InitializeComponent() {
			lock(_initLock) {
				if (!_initialized) {
					RuntimeLogger.SetUp("eSpace CaseConferencing", true);
		...
		protected void Application_Start(Object sender, EventArgs e) {
			try {
				...
				Application["EspaceName"] = "CaseConferencing";
				...
				eSpaceInfo.ESpaceName = "CaseConferencing";
				eSpaceInfo.ESpaceId = eSpaceId;
				eSpaceInfo.ESpaceVersionId = 667;
		...
		protected void Application_AcquireRequestState(Object sender, EventArgs e) {
			...
			RunningInfo.ESpaceHash = "g0uLCim5I0oi4f+yckzixg";
			RunningInfo.ESpaceVersionId = 667;
			...
			var sessionCookieKey = Response.Cookies.AllKeys.FirstIfSingleOrDefault(c => c.ToLower() == "asp.net_sessionid");
			...
			if (Request.UserAgent != null && RuntimePlatformUtils.ShouldCreateCookieForRequest()) {
				if (Request.CurrentExecutionFilePath.ToLowerInvariant().EndsWith(".aspx")) {
					...
					Context.Items["osRequest"] = requestId;
		...
		public static string GetStringResource(string key, string defaultValue) {
			...
			if (embeddedResourceManager == null) {
				lock(embeddedResourceManagerLock) {
					if (embeddedResourceManager == null) {
						string baseResourceName = "CaseConferencing" + "Language";
