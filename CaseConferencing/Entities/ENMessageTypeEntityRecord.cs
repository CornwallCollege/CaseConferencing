...
namespace ssCaseConferencing {
	...
	public sealed partial class ENMessageTypeEntity {
		...
		public static string ViewName(int? tenant, string locale) {
			return RsseSpaceRichWidgets.ENMessageTypeEntity.ViewName(tenant, locale);
		}
	...
	/// </summary>
	[OutSystems.HubEdition.RuntimePlatform.MetaInformation.EntityRecordDetails("MessageType", "3gpB4NLPv02vKdrpkjAWGA", "sxSgg9oQRkKKlyKvezqjKg", 0, "OSUSR_5z9_MessageType", "")]
	[Serializable()]
	public partial struct ENMessageTypeEntityRecord: ISerializable, ITypedRecord<ENMessageTypeEntityRecord>, ISimpleRecord {
		private static readonly GlobalObjectKey IdId = GlobalObjectKey.Parse("sxSgg9oQRkKKlyKvezqjKg*FLEul99RCkSgDsy4MUvbIQ");
		private static readonly GlobalObjectKey IdLabel = GlobalObjectKey.Parse("sxSgg9oQRkKKlyKvezqjKg*2MMcnI8kC0SMGE_IEB30MQ");
	...
	/// <summary>
	/// Static Entity <code>ENMessageTypeEntity</code> gets the values for this static entity records in
	///  runtime <code>MessageType</code>
	/// </summary>
	partial class ENMessageTypeEntity {


		static ENMessageTypeEntity() {
			ENMessageTypeEntityRecordTypeFactoryImpl.InitializeFactory();
		}

		public static ENMessageTypeEntityRecord GetRecordById(int id) {
			return (ENMessageTypeEntityRecord) RsseSpaceRichWidgets.ENMessageTypeEntity.GetRecordById(id);
		}

		public static ENMessageTypeEntityRecord GetRecordByName(string name) {
			return (ENMessageTypeEntityRecord) RsseSpaceRichWidgets.ENMessageTypeEntity.GetRecordByName(name);
		}

		public static ENMessageTypeEntityRecord GetRecordByKey(ObjectKey key) {
			return (ENMessageTypeEntityRecord) RsseSpaceRichWidgets.ENMessageTypeEntity.GetRecordByKey(key);
		}
	} // ENMessageTypeEntity;
	/// <summary>
	...
	public partial struct RCMessageTypeRecord: ISerializable, ITypedRecord<RCMessageTypeRecord> {
		private static readonly GlobalObjectKey IdMessageType = GlobalObjectKey.Parse("2UmDmepsh0WSfJ_D1JexCA*+dil9kGXNtlsFbKinA9xhQ");
		...
		public RCMessageTypeRecord(SerializationInfo info, StreamingContext context) {
			...
			fields = objInfo.GetFields(BindingFlags.NonPublic | BindingFlags.Instance | BindingFlags.Public);
			if (fields[0] .FieldType.IsSerializable)
			ssENMessageType = (ENMessageTypeEntityRecord) info.GetValue(fields[0] .Name, fields[0] .FieldType);
		}
	...
	/// <summary>
	/// RecordList type <code>RLMessageTypeList</code> that represents a record list of <code>Text,
	///  Integer</code>
	/// </summary>
	[Serializable()]
	...
	public partial class ExtendedActions {
		...
		public static void GetMessageType(HeContext heContext, int inParamId, out RCMessageTypeRecord outParamRecord) {
			...
			try {
				heContext.CurrentESpaceId = ENMessageTypeEntity.eSpaceId;
				try {
