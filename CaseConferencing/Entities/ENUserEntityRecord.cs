...
namespace ssCaseConferencing {
	...
	public sealed partial class ENUserEntity {
		...
		public static string ViewName(int? tenant, string locale) {
			return string.Format(BaseAppUtils.EscapeAndQualifySqlIdentifier(DatabaseAccess.ForEspaceDatabase(1), "{0}"), tenant.HasValue ? "OSSYS_USER_T" + tenant: "OSSYS_USER");
		}
	...
	/// </summary>
	[OutSystems.HubEdition.RuntimePlatform.MetaInformation.EntityRecordDetails("User", "h1sEUHeoKtFo_fKDVf_IzQ", "uXCIR2Atc0+es3zYuZSnNw", 0, "ossys_user", "")]
	[Serializable()]
	public partial struct ENUserEntityRecord: ISerializable, ITypedRecord<ENUserEntityRecord>, ISimpleRecord {
		...
		[OutSystems.HubEdition.RuntimePlatform.MetaInformation.EntityAttributeDetails("NAME", 256, false, false, false)]
		...
		[OutSystems.HubEdition.RuntimePlatform.MetaInformation.EntityAttributeDetails("USERNAME", 250, false, false, false)]
		...
		[OutSystems.HubEdition.RuntimePlatform.MetaInformation.EntityAttributeDetails("PASSWORD", 256, false, false, false)]
		...
		[OutSystems.HubEdition.RuntimePlatform.MetaInformation.EntityAttributeDetails("EMAIL", 250, false, false, false)]
		...
		[OutSystems.HubEdition.RuntimePlatform.MetaInformation.EntityAttributeDetails("MOBILEPHONE", 20, false, false, false)]
		...
		[OutSystems.HubEdition.RuntimePlatform.MetaInformation.EntityAttributeDetails("EXTERNAL_ID", 36, false, false, false)]
		...
		[OutSystems.HubEdition.RuntimePlatform.MetaInformation.EntityAttributeDetails("CREATION_DATE", 0, false, false, false)]
		...
		[OutSystems.HubEdition.RuntimePlatform.MetaInformation.EntityAttributeDetails("LAST_LOGIN", 0, false, false, false)]
		...
		public ENUserEntityRecord(SerializationInfo info, StreamingContext context) {
			...
			_ssUsername = (string) info.GetValue(fields[3] .Name, fields[3] .FieldType);
			if (fields[4] .FieldType.IsSerializable)
			_ssPassword = (string) info.GetValue(fields[4] .Name, fields[4] .FieldType);
			if (fields[5] .FieldType.IsSerializable)
			_ssEmail = (string) info.GetValue(fields[5] .Name, fields[5] .FieldType);
			if (fields[6] .FieldType.IsSerializable)
			_ssMobilePhone = (string) info.GetValue(fields[6] .Name, fields[6] .FieldType);
			if (fields[7] .FieldType.IsSerializable)
			_ssExternal_Id = (string) info.GetValue(fields[7] .Name, fields[7] .FieldType);
			if (fields[8] .FieldType.IsSerializable)
			_ssCreation_Date = (DateTime) info.GetValue(fields[8] .Name, fields[8] .FieldType);
			if (fields[9] .FieldType.IsSerializable)
			_ssLast_Login = (DateTime) info.GetValue(fields[9] .Name, fields[9] .FieldType);
			if (fields[10] .FieldType.IsSerializable)
			_ssIs_Active = (bool) info.GetValue(fields[10] .Name, fields[10] .FieldType);
		}
	...
	/// <summary>
	/// RecordList type <code>RLUserList</code> that represents a record list of <code>Text, Text, Text,
	///  Text, PhoneNumber, Email, DateTime, DateTime, Boolean, Integer, Integer</code>
	/// </summary>
	[Serializable()]
	...
	public partial class ExtendedActions {
		...
		public static void CreateUser(HeContext heContext, RCUserRecord inParamSource, out int outParamId) {
			...
			try {
				heContext.CurrentESpaceId = ENUserEntity.eSpaceId;
