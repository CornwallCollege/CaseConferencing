...
namespace ssCaseConferencing {
	...
	public sealed partial class ENMenuItemEntity {
		...
		public static string ViewName(int? tenant, string locale) {
			switch (locale == null ? "":
				...
				default:
					...
					return BaseAppUtils.EscapeAndQualifySqlIdentifier(DatabaseAccess.ForEspaceDatabase(10), "OSUSR_pkx_MenuItem");
				}
			}
		} // ENMenuItemEntity
		...
		///  <code>MenuItem</code> <p> Description: Records in this entity will be automatically created whe
		/// n dragging web screens to the Common\Menu web block. Their labels can later be changed.</p>
		/// </summary>
		[OutSystems.HubEdition.RuntimePlatform.MetaInformation.EntityRecordDetails("MenuItem", "Entity5B57028B-F636-4BA3-93F9-C81CACBC5638", "shmcdFKEAEWXZGfrlZEwCQ", 0, "OSUSR_pkx_MenuItem", null)]
		[Serializable()]
		public partial struct ENMenuItemEntityRecord: ISerializable, ITypedRecord<ENMenuItemEntityRecord>, ISimpleRecord {
			private static readonly GlobalObjectKey IdId = GlobalObjectKey.Parse("shmcdFKEAEWXZGfrlZEwCQ*R33XWJvSxw4LUkh9JfGD+w");
			private static readonly GlobalObjectKey IdOrder = GlobalObjectKey.Parse("shmcdFKEAEWXZGfrlZEwCQ*yjbSVyRHeQj+bINsKjLKzQ");
			private static readonly GlobalObjectKey IdCaption = GlobalObjectKey.Parse("shmcdFKEAEWXZGfrlZEwCQ*h638tE3zOU6SFAHeugbmxQ");
		...
		partial class ENMenuItemEntity: StaticEntityRuntime {
			...
			private static ENMenuItemEntity instance = new ENMenuItemEntity(10, ObjectKey.Parse("Entity5B57028B-F636-4BA3-93F9-C81CACBC5638"));
		...
		public partial struct RCMenuItemRecord: ISerializable, ITypedRecord<RCMenuItemRecord> {
			private static readonly GlobalObjectKey IdMenuItem = GlobalObjectKey.Parse("2UmDmepsh0WSfJ_D1JexCA*FdRd8decrXB3DA0i73szrw");
			...
			public RCMenuItemRecord(SerializationInfo info, StreamingContext context) {
				...
				fields = objInfo.GetFields(BindingFlags.NonPublic | BindingFlags.Instance | BindingFlags.Public);
				if (fields[0] .FieldType.IsSerializable)
				ssENMenuItem = (ENMenuItemEntityRecord) info.GetValue(fields[0] .Name, fields[0] .FieldType);
			}
		...
		/// <summary>
		/// RecordList type <code>RLMenuItemList</code> that represents a record list of <code>Text, Integer,
		///  Integer</code>
		/// </summary>
		[Serializable()]
