...
namespace ssCaseConferencing {
	...
	/// </summary>
	[OutSystems.HubEdition.RuntimePlatform.MetaInformation.EntityRecordDetails("IconName", "YQRuVlDB9kmYnzpwJWAXxg", "sxSgg9oQRkKKlyKvezqjKg", 0, "OSUSR_5z9_IconName", "")]
	[Serializable()]
	public partial struct ENIconNameEntityRecord: ISerializable, ITypedRecord<ENIconNameEntityRecord>, ISimpleRecord {
		...
		[OutSystems.HubEdition.RuntimePlatform.MetaInformation.EntityAttributeDetails("CLASS", 50, false, true, false)]
		...
		public ENIconNameEntityRecord(SerializationInfo info, StreamingContext context) {
			...
			_ssClass = (string) info.GetValue(fields[0] .Name, fields[0] .FieldType);
		}
	...
	public partial struct RCIconNameRecord: ISerializable, ITypedRecord<RCIconNameRecord> {
		...
		public RCIconNameRecord(SerializationInfo info, StreamingContext context) {
			...
			fields = objInfo.GetFields(BindingFlags.NonPublic | BindingFlags.Instance | BindingFlags.Public);
			if (fields[0] .FieldType.IsSerializable)
			ssENIconName = (ENIconNameEntityRecord) info.GetValue(fields[0] .Name, fields[0] .FieldType);
		}
