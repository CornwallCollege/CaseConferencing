...
namespace ssCaseConferencing {
	...
	public sealed partial class ENMenuSubItemEntity {
		...
		public static string ViewName(int? tenant, string locale) {
			switch (locale == null ? "":
				...
				default:
					...
					return BaseAppUtils.EscapeAndQualifySqlIdentifier(DatabaseAccess.ForEspaceDatabase(10), "OSUSR_pkx_MenuSubItem");
				}
			}
		} // ENMenuSubItemEntity
		...
		/// </summary>
		[OutSystems.HubEdition.RuntimePlatform.MetaInformation.EntityRecordDetails("MenuSubItem", "_AlAd77Q40qB90+b+ar8kg", "shmcdFKEAEWXZGfrlZEwCQ", 0, "OSUSR_pkx_MenuSubItem", null)]
		[Serializable()]
		public partial struct ENMenuSubItemEntityRecord: ISerializable, ITypedRecord<ENMenuSubItemEntityRecord>, ISimpleRecord {
			private static readonly GlobalObjectKey IdId = GlobalObjectKey.Parse("shmcdFKEAEWXZGfrlZEwCQ*MwXuS_MKKUy2c4wBTUCivA");
			private static readonly GlobalObjectKey IdOrder = GlobalObjectKey.Parse("shmcdFKEAEWXZGfrlZEwCQ*QCHQ4zctj0SwAfYh6VESVA");
			private static readonly GlobalObjectKey IdCaption = GlobalObjectKey.Parse("shmcdFKEAEWXZGfrlZEwCQ*_XjyTo8c8k+d2KI0zVNxww");
			private static readonly GlobalObjectKey IdMenuItemId = GlobalObjectKey.Parse("shmcdFKEAEWXZGfrlZEwCQ*SlTN33Yy9EqR9MHDEJTHnQ");
			...
			[OutSystems.HubEdition.RuntimePlatform.MetaInformation.EntityAttributeDetails("MENUITEMID", 0, false, false, true)]
			...
			public ENMenuSubItemEntityRecord(SerializationInfo info, StreamingContext context) {
				...
				_ssMenuItemId = (int) info.GetValue(fields[3] .Name, fields[3] .FieldType);
			}
		...
		partial class ENMenuSubItemEntity: StaticEntityRuntime {
			...
			private static ENMenuSubItemEntity instance = new ENMenuSubItemEntity(10, ObjectKey.Parse("_AlAd77Q40qB90+b+ar8kg"));
		...
		public partial struct RCMenuSubItemRecord: ISerializable, ITypedRecord<RCMenuSubItemRecord> {
			private static readonly GlobalObjectKey IdMenuSubItem = GlobalObjectKey.Parse("2UmDmepsh0WSfJ_D1JexCA*x0rQQFz6QTulHfXU684xCA");
			...
			public RCMenuSubItemRecord(SerializationInfo info, StreamingContext context) {
				...
				fields = objInfo.GetFields(BindingFlags.NonPublic | BindingFlags.Instance | BindingFlags.Public);
				if (fields[0] .FieldType.IsSerializable)
				ssENMenuSubItem = (ENMenuSubItemEntityRecord) info.GetValue(fields[0] .Name, fields[0] .FieldType);
			}
		...
		/// <summary>
		/// RecordList type <code>RLMenuSubItemList</code> that represents a record list of <code>Text,
		///  Integer, Integer, MenuItemIdentifier</code>
		/// </summary>
		[Serializable()]
