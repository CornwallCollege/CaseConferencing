...
namespace ssCaseConferencing {
	...
	/// </summary>
	[OutSystems.HubEdition.RuntimePlatform.MetaInformation.EntityRecordDetails("IconSize", "x8hUd6PlmkCgJdD3DWtSUg", "sxSgg9oQRkKKlyKvezqjKg", 0, "OSUSR_5z9_IconSize", "")]
	[Serializable()]
	...
	public partial struct RCIconSizeRecord: ISerializable, ITypedRecord<RCIconSizeRecord> {
		...
		public RCIconSizeRecord(SerializationInfo info, StreamingContext context) {
			...
			fields = objInfo.GetFields(BindingFlags.NonPublic | BindingFlags.Instance | BindingFlags.Public);
			if (fields[0] .FieldType.IsSerializable)
			ssENIconSize = (ENIconSizeEntityRecord) info.GetValue(fields[0] .Name, fields[0] .FieldType);
		}
