...
namespace ssCaseConferencing {
	...
	public partial struct STYAxisFormatStructure: ISerializable, ITypedRecord<STYAxisFormatStructure>, ISimpleRecord {
		...
		static STYAxisFormatStructure() {
			ssCaseConferencing.STYAxisFormatStructureTypeFactoryImpl.InitializeFactory();
		}
		...
		public STYAxisFormatStructure(params string[] dummy) {
			...
			ssTitle = "";
			ssMinValue = -2147483647M;
			ssMaxValue = -2147483647M;
			ssValuesPrefix = "";
			ssValuesSuffix = "";
			ssGridLineStep = -2147483647M;
		}
		...
		public STYAxisFormatStructure(SerializationInfo info, StreamingContext context) {
			...
			ssTitle = (string) info.GetValue(fields[0] .Name, fields[0] .FieldType);
			if (fields[1] .FieldType.IsSerializable)
			ssMinValue = (decimal) info.GetValue(fields[1] .Name, fields[1] .FieldType);
			if (fields[2] .FieldType.IsSerializable)
			ssMaxValue = (decimal) info.GetValue(fields[2] .Name, fields[2] .FieldType);
			if (fields[3] .FieldType.IsSerializable)
			ssValuesPrefix = (string) info.GetValue(fields[3] .Name, fields[3] .FieldType);
			if (fields[4] .FieldType.IsSerializable)
			ssValuesSuffix = (string) info.GetValue(fields[4] .Name, fields[4] .FieldType);
			if (fields[5] .FieldType.IsSerializable)
			ssGridLineStep = (decimal) info.GetValue(fields[5] .Name, fields[5] .FieldType);
		}
	...
	public partial struct RCYAxisFormatRecord: ISerializable, ITypedRecord<RCYAxisFormatRecord> {
		...
		static RCYAxisFormatRecord() {
			ssCaseConferencing.RCYAxisFormatRecordTypeFactoryImpl.InitializeFactory();
		}
		...
		public RCYAxisFormatRecord(SerializationInfo info, StreamingContext context) {
			...
			fields = objInfo.GetFields(BindingFlags.NonPublic | BindingFlags.Instance | BindingFlags.Public);
			if (fields[0] .FieldType.IsSerializable)
			ssSTYAxisFormat = (STYAxisFormatStructure) info.GetValue(fields[0] .Name, fields[0] .FieldType);
		}
...
namespace ssCaseConferencing {
	...
	public class WORCYAxisFormatRecord {
		...
		public WORCYAxisFormatRecord() {
			varWSTitle = (string) "";
			varWSMinValue = (decimal) -2147483647M;
			varWSMaxValue = (decimal) -2147483647M;
			varWSValuesPrefix = (string) "";
			varWSValuesSuffix = (string) "";
			varWSGridLineStep = (decimal) -2147483647M;
		}
