...
namespace ssCaseConferencing {
	...
	public partial struct STAdvancedFormatStructure: ISerializable, ITypedRecord<STAdvancedFormatStructure>, ISimpleRecord {
		...
		static STAdvancedFormatStructure() {
			ssCaseConferencing.STAdvancedFormatStructureTypeFactoryImpl.InitializeFactory();
		}
		...
		public STAdvancedFormatStructure(SerializationInfo info, StreamingContext context) {
			...
			ssDataPointFormats = (RLAdvancedDataPointFormatRecordList) info.GetValue(fields[0] .Name, fields[0] .FieldType);
			if (fields[1] .FieldType.IsSerializable)
			ssDataSeriesFormats = (RLAdvancedDataSeriesFormatRecordList) info.GetValue(fields[1] .Name, fields[1] .FieldType);
			if (fields[2] .FieldType.IsSerializable)
			ssXAxisJSON = (string) info.GetValue(fields[2] .Name, fields[2] .FieldType);
			if (fields[3] .FieldType.IsSerializable)
			ssYAxisJSON = (string) info.GetValue(fields[3] .Name, fields[3] .FieldType);
			if (fields[4] .FieldType.IsSerializable)
			ssHighchartsJSON = (string) info.GetValue(fields[4] .Name, fields[4] .FieldType);
		}
	...
	public partial struct RCAdvancedFormatRecord: ISerializable, ITypedRecord<RCAdvancedFormatRecord> {
		...
		static RCAdvancedFormatRecord() {
			ssCaseConferencing.RCAdvancedFormatRecordTypeFactoryImpl.InitializeFactory();
		}
		...
		public RCAdvancedFormatRecord(SerializationInfo info, StreamingContext context) {
			...
			fields = objInfo.GetFields(BindingFlags.NonPublic | BindingFlags.Instance | BindingFlags.Public);
			if (fields[0] .FieldType.IsSerializable)
			ssSTAdvancedFormat = (STAdvancedFormatStructure) info.GetValue(fields[0] .Name, fields[0] .FieldType);
		}
