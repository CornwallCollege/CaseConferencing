...
namespace ssCaseConferencing {
	...
	public partial struct STXAxisFormatStructure: ISerializable, ITypedRecord<STXAxisFormatStructure>, ISimpleRecord {
		...
		static STXAxisFormatStructure() {
			ssCaseConferencing.STXAxisFormatStructureTypeFactoryImpl.InitializeFactory();
		}
		...
		public STXAxisFormatStructure(SerializationInfo info, StreamingContext context) {
			...
			ssLabelsRotation = (int) info.GetValue(fields[1] .Name, fields[1] .FieldType);
			if (fields[2] .FieldType.IsSerializable)
			ssMinValue = (string) info.GetValue(fields[2] .Name, fields[2] .FieldType);
			if (fields[3] .FieldType.IsSerializable)
			ssMaxValue = (string) info.GetValue(fields[3] .Name, fields[3] .FieldType);
			if (fields[4] .FieldType.IsSerializable)
			ssValuesType = (int) info.GetValue(fields[4] .Name, fields[4] .FieldType);
		}
	...
	public partial struct RCXAxisFormatRecord: ISerializable, ITypedRecord<RCXAxisFormatRecord> {
		...
		static RCXAxisFormatRecord() {
			ssCaseConferencing.RCXAxisFormatRecordTypeFactoryImpl.InitializeFactory();
		}
		...
		public RCXAxisFormatRecord(SerializationInfo info, StreamingContext context) {
			...
			fields = objInfo.GetFields(BindingFlags.NonPublic | BindingFlags.Instance | BindingFlags.Public);
			if (fields[0] .FieldType.IsSerializable)
			ssSTXAxisFormat = (STXAxisFormatStructure) info.GetValue(fields[0] .Name, fields[0] .FieldType);
		}
