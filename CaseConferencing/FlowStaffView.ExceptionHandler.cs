...
namespace ssCaseConferencing.Flows.FlowStaffView {
	...
	public class ExceptionHandler {
		...
		public bool HandleException(ref LocalState flowState) {
			...
			if (heContext.VisitedExceptionHandlerFlows.Contains("StaffView")) {
				return false;
			}
			heContext.VisitedExceptionHandlerFlows.Add("StaffView");
			...
			if (heContext.CanUseCustomErrorHandler(excep)) {
				if (new RsseSpaceThemeProvider.Themes.ThemeThemeProviderWithoutLondon.ExceptionHandler(Page, isEmailScreen).HandleException()) {
					return true;
				}
