...
namespace ssCaseConferencing.Flows.FlowSafeguarding {
	...
	public class ScrnStaffSelectPopup: OSPageViewStateCompressed, IWebScreen, INegotiateTabIndexes, IBookmarkableURL {


		public ScrnStaffSelectPopup(): base(CaseConferencing_Properties.QuirksMode) {
		}


		/// <summary>
		/// Variable <code>varLcStaff</code> that represents the Service Studio local variable
		///  <code>Staff</code> <p>Description: </p>
		/// </summary>
		int varLcStaff = 0;

		/// <summary>
		/// Variable <code>varLcExternalName</code> that represents the Service Studio local variable
		///  <code>ExternalName</code> <p>Description: </p>
		/// </summary>
		string varLcExternalName = "";
		...
		protected OutSystems.HubEdition.WebWidgets.RequiredFieldTextValidator wt_ComboBox16ValidatorRequired;
		protected SelectRtWidget Rt_wt_ComboBox16 = new SelectRtWidget();
		RLStaffListRecordList Rt_wt_ComboBox16_reclist = null;
		...
		protected string GetRequestInfoJavaScript() {
			return GetRequestInfoJavaScript("D82rwvmYX0+HFMij38lEcw", "StaffSelectPopup");
		}
		...
		protected string GetHeadTopJavaScript() {
			return GetInjectedCode(CodeInjectionFactory.Locations.HeadTop, "D82rwvmYX0+HFMij38lEcw", "StaffSelectPopup");
		}

		protected string GetHeadBottomJavaScript() {
			return GetInjectedCode(CodeInjectionFactory.Locations.HeadBottom, "D82rwvmYX0+HFMij38lEcw", "StaffSelectPopup");
		}

		protected string GetBodyTopJavaScript() {
			return GetInjectedCode(CodeInjectionFactory.Locations.BodyTop, "D82rwvmYX0+HFMij38lEcw", "StaffSelectPopup");
		}

		protected string GetBodyBottomJavaScript() {
			return GetInjectedCode(CodeInjectionFactory.Locations.BodyBottom, "D82rwvmYX0+HFMij38lEcw", "StaffSelectPopup");
		}
		...
		protected void InitializeUrls() {
			...
			if (Request.AppRelativeCurrentExecutionFilePath.IndexOf('/', 2) == -1) {
				...
				actionUrl += AppUtils.GetPageName(heContext, Global.eSpaceId, "StaffSelectPopup", parameters,/*useParamsOnlyIfNeededForRule*/ true);
			}
			bookmarkableUrl += AppUtils.GetPageName(heContext, Global.eSpaceId, "StaffSelectPopup", parameters,/*useParamsOnlyIfNeededForRule*/ false);
		...
		private void Page_Load(object sender, System.EventArgs e) {
			...
			if (!IsPostBack) {
				ArrayList screenParameters = (ArrayList) Global.App.OsContext.Session["CaseConferencing._ScreenParameters_StaffSelectPopup"];
				...
				if ((screenParametersKey == null || this.Key.Equals(ObjectKey.Parse(Convert.ToString(screenParametersKey)))) && screenParameters != null) {
					try {
						...
						Global.App.OsContext.Session["CaseConferencing._ScreenParameters_StaffSelectPopup"] = null;
		...
		public ObjectKey Key {
			get {
				return ObjectKey.Parse("D82rwvmYX0+HFMij38lEcw"); 
			}
		}
		...
		private bool CommandOk(HeContext heContext) {
			...
			try {
				// Popup_Editor_Notify
				Actions.ActionPopup_Editor_Notify(heContext, ((Convert.ToString(varLcStaff) + "|") +varLcExternalName));
				// Popup_Editor_Close
				Actions.ActionPopup_Editor_Close(heContext);
				// Update Screen
				return true;
		...
		public string cnt_Container12_setInlineAttributes(object sender, System.EventArgs e) {
			{
				string newstyledef;
				string oldstyledef;
				newstyledef = "padding-right:0px; margin-right:0px";
				oldstyledef = ((IAttributeAccessor) sender).GetAttribute("style");
				if (oldstyledef != null) {
					if (!oldstyledef.TrimEnd().EndsWith(";")) newstyledef = ";" + newstyledef;
					((IAttributeAccessor) sender).SetAttribute("style", oldstyledef + newstyledef.ToString());
		...
		/// <summary>
		/// wt_ComboBox16 Functions
		/// </summary>
		public void sel_ComboBox16_onDataBinding(object sender, System.EventArgs e) {
			if (!((OutSystems.HubEdition.WebWidgets.DropDownList) sender).Visible) return;

			RLStaffListRecordList Rt_wt_ComboBox16_reclist = queryResGetStaffs_outParamList;
			Rt_wt_ComboBox16_reclist.StartIteration();
			try {
				while (!Rt_wt_ComboBox16_reclist.Eof) {
					((OutSystems.HubEdition.WebWidgets.DropDownList) sender).Items.Add(new ListItem(Rt_wt_ComboBox16_reclist.CurrentRec.ssSTStaffList.ssStaffName, Convert.ToString(Rt_wt_ComboBox16_reclist.CurrentRec.ssSTStaffList.ssStaffID)));
					if (varLcStaff == Convert.ToInt32(Convert.ToString(Rt_wt_ComboBox16_reclist.CurrentRec.ssSTStaffList.ssStaffID))) {
					...
					Rt_wt_ComboBox16_reclist.Advance();
				}
			} finally {
				Rt_wt_ComboBox16_reclist.EndIteration();
			}
		}
		public void sel_ComboBox16_dropDown_valueChanged(object sender, System.EventArgs e) {
			...
			if (dropDown.SelectedValue.StartsWith("__ossli_")) {
				Rt_wt_ComboBox16.SpecialListVal = dropDown.SelectedValue.Substring(8);
				varLcStaff = 0;
			}
			else {
				Rt_wt_ComboBox16.SpecialListVal = "";
				try {
					varLcStaff = Convert.ToInt32(dropDown.SelectedValue);
				} catch (Exception) {}
			}
		}
		/// <summary>
		/// Gets the visible state of component (wt_ComboBox16)
		/// </summary>
		/// <returns>The Visible State of wt_ComboBox16</returns>
		public bool sel_ComboBox16_isVisible() {
			return true;
		}

		/// <summary>
		/// Gets the enabled state of component (wt_ComboBox16)
		/// </summary>
		/// <returns>The Enabled State of wt_ComboBox16</returns>
		public bool sel_ComboBox16_isEnabled() {
			return true; 
		}

		/// <summary>
		/// Gets the mandatory value of component (sel_ComboBox16)
		/// </summary>
		/// <returns>The Mandatory Value of sel_ComboBox16</returns>
		public bool sel_ComboBox16_isMandatory() {
			return false;
		}
		...
		public string inputwt_Input4_input_value() {
			if (("" !=varLcExternalName)) {
				return varLcExternalName;
			} else {
		...
		public void inputwt_Input4_input_onTextChanged(object sender, EventArgs e) {
			try {
				if ("" == ((OutSystems.HubEdition.WebWidgets.TextBox) sender).Text) {
					...
					varLcExternalName = Convert.ToString(((OutSystems.HubEdition.WebWidgets.TextBox) sender).Text); 
				}
		...
		public static class FuncssPreparation {
			...
			public static RLStaffListRecordList QueryGetStaffs(HeContext heContext, int maxRecords, IterationMultiplicity multiplicity, out int outParamCount) {
				...
				string advSql = "SELECT  {Staff}.[ID],  {Staff}.[FORENAMES] +   {Staff}.[SURNAME]  " +
				 "FROM  {Staff}  " +
				...
				try {
					...
					if (multiplicity == IterationMultiplicity.Multiple) {
						...
						try {
							DatabaseAccess.ForCurrentDatabase.ExecuteQuery(sqlCmd, _tmp, "Query Safeguarding.StaffSelectPopup.Preparation.GetStaffs.List");
						...
						try {
							DatabaseAccess.ForCurrentDatabase.ExecuteQuery(sqlCmd, outParamList, "Query Safeguarding.StaffSelectPopup.Preparation.GetStaffs.List");
					...
					if (aqExcep.Message.StartsWith("Command parameter[")) {
						throw new DataBaseException("Problems accessing parameters in advanced query GetStaffs in Preparation in StaffSelectPopup in Safeguarding in CaseConferencing (SELECT {Staff}.[Id], {Staff}.[Forenames] +  {Staff}.[Surname]  FROM {Staff}  WHERE {Staff}.[Forenames] <> ''  ORDER BY {Staff}.[Forenames],  {Staff}.[Surname]): " + aqExcep.Message);
					}
					throw new DataBaseException("Error in advanced query GetStaffs in Preparation in StaffSelectPopup in Safeguarding in CaseConferencing (SELECT {Staff}.[Id], {Staff}.[Forenames] +  {Staff}.[Surname]  FROM {Staff}  WHERE {Staff}.[Forenames] <> ''  ORDER BY {Staff}.[Forenames],  {Staff}.[Surname]): " + aqExcep.Message);
		...
		protected override void StoreViewState() {
			base.StoreViewState();
			ViewStateAttributes.SetInViewState("varLcStaff", varLcStaff, 0);
			ViewStateAttributes.SetInViewState("varLcExternalName", varLcExternalName, "");
			ViewStateAttributes.SetInViewState("wt_ComboBox16_Mandatory", ((IWidgetRuntimeProperties) this.FindControl("wt_ComboBox16")).Mandatory, false);
		...
		protected override void FetchViewState() {
			base.FetchViewState();
			try {
				varLcStaff = (int) ViewStateAttributes.GetFromViewState("varLcStaff", 0);
				varLcExternalName = (string) ViewStateAttributes.GetFromViewState("varLcExternalName", "");
				((IWidgetRuntimeProperties) this.FindControl("wt_ComboBox16")).Mandatory = (bool) ViewStateAttributes.GetFromViewState("wt_ComboBox16_Mandatory", false);
		...
		public void OnSubmit(string parentEditRecord, bool validate) {
			ValidationUtils.ValidateComboBox(this, "wt_ComboBox16", parentEditRecord, validate);
