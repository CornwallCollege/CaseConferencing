...
namespace ssCaseConferencing {
	...
	public partial class Actions {
		...
		/// </summary>
		public static void ActionCreateZip(HeContext heContext, int inParamCompressionLevel, out object outParamZipHandle) {
			RssExtensionZip.MssCreateZip(heContext, inParamCompressionLevel, out outParamZipHandle);
		}
