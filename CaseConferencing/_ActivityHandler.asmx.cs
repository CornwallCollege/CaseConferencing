...
namespace ssCaseConferencing.Processes.Handling {
	public class ActivityActionsHandler: System.Web.Services.WebService {
		...
		private static int SchedulerActivitiesTimeout = Settings.GetInt(Settings.Configs.Scheduler_ActivitiesTimeout);
		private static int SchedulerAutomaticActivitiesTimeout = Settings.GetInt(Settings.Configs.Scheduler_AutomaticActivitiesTimeout);
