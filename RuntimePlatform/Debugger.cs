...
namespace OutSystems.HubEdition.RuntimePlatform {
    ...
    public class Debugger : System.Web.Services.WebService {
        ...
        private static DebugSessions _debugSessions_notToBeUsedDirectly;
        ...
        internal static void CleanCurrentProcessInfo(bool forceClean) {
            ...
            if (forceClean || !ThreadDataExists || ThreadData.LastExceptionThrown == null) {
                ...
                ProcessInfo = new ProcessInfo() {
                    ...
                    PrecedentActivitySuccessorsCount = -1,
                    TopProcessId = -1
                };
            }
        }
...
#if JAVA
                    string url = "http://localhost/ServiceCenter/IntegratedDebugger?wsdl";
#else
                    string portSnippet = System.Web.HttpContext.Current.Request.IsSecureConnection ?
                                            Settings.GetInt(Settings.Configs.ApplicationServerPort).ToString() :
                                            System.Web.HttpContext.Current.Request.ServerVariables["SERVER_PORT"];

                    string url = "http://" + RuntimePlatformUtils.FixHostIPForIPV6(Settings.Get(Settings.Configs.InternalAddress)) + ":" + portSnippet + "/ServiceCenter/IntegratedDebugger.asmx";
#endif
            ...
            try {
                ...
                if (sendExceptionThrownEvent) {
                    ...
                    ThreadData.SendBreakpointEventAndWaitForCommand(
                        sessions,
                        new ExceptionThrownEvent(lastException, isUnhandled), null, null);
                }
                if (disposeException) {
        ...
        public static void HandleUnhandledException() {
            try {
                ...
                ThreadData.SendBreakpointEventAndWaitForCommand(
                    sessions,
                    new ExceptionThrownEvent(lastException, /*isUnhandled*/true), null, null);
        ...
        [Obsolete("New debugger protocol for 5.0.2.0")]
        [MethodImpl(MethodImplOptions.NoInlining)]
        public static LocalState Push(string eSpaceName, string functionId, string functionName) {
            return new LocalState(eSpaceName, functionId, functionName, "", (IScreen)null, (IVarsBag)null);
        }

        [Obsolete("New debugger protocol for 5.0.2.0")]
        [MethodImpl(MethodImplOptions.NoInlining)]
        public static LocalState Push(string eSpaceName, string functionId, string functionName, object page, IVarsBag localVars, IVarsBag outputVars) {
            return new LocalState(eSpaceName, functionId, functionName, "", (IScreen)page, new IVarsBag[] { localVars, outputVars });
        }

        [Obsolete("New debugger protocol for 5.0.2.0")]
        [MethodImpl(MethodImplOptions.NoInlining)]
        public static LocalState Push(string eSpaceName, string functionId, string functionName, string functionType, object page, IVarsBag localVars, IVarsBag outputVars) {
            return new LocalState(eSpaceName, functionId, functionName, functionType, (IScreen)page, new IVarsBag[] { localVars, outputVars });
        }

        [MethodImpl(MethodImplOptions.NoInlining)]
        public static LocalState Push(string eSpaceName, string functionId, string functionName, string functionType) {
            return Push(eSpaceName, functionId, functionName, functionType, (IScreen)null, (IVarsBag) null);
        }
        ...
        [MethodImpl(MethodImplOptions.NoInlining)]
        public static LocalState Push(string eSpaceName, string functionId, string functionName, string functionType, IScreen page, params IVarsBag[] list) {
            try {
    ...
    class EventQueue {
        ...
        public void Enqueue(DebuggerEvent _event) {
            lock (events) {
                ...
                events.Add(OutSystems.RuntimeCommon.Pair.Create(++lastId, _event));
                if (_event is StopDebugSessionEvent) {
    ...
    public class ExceptionThrownEvent : EventWithStack {
        ...
        protected bool isUnhandled;

        public ExceptionThrownEvent(ExceptionData data, bool isUnhandled)
    ...
    public class ThreadData {
        ...
        class LongLivedRequestData {
            ...
            public DebugCommand lastDebugCommand = null;
        ...
        public DebugCommand LastDebugCommand {
            ...
            private set { longLivedRequestData.lastDebugCommand = value; }
        }
    ...
    public class StackManager : IDebuggerSerializable {
        ...
        private VarValue Evaluate(string varName, string varType, int detailLevel, int stackLevel) {
            ...
            switch (varType) {
                ...
                case "local":
                    ...
                    bool isSMSScreen = (!isWebScreen && (page is IScreen));
                    ...
                    if (page != null) {
                        ...
                        if (isWebScreen) {
                            ...
                            controlId = "- widget IDs are not applicable for SMS Screens -";
                        }
                        if (controlId != null) {
                            if (!varValue.Found) {
                            ...
                            if (varValue.Value is IRtWidget) {
                                ...
                                widget.Page = page;
                            } else if (IsSmsRecordListRtWidget(varValue.Value)) {
                                varValue.Value = "- unable to evaluate -";
                            }
                        }
                    }
        ...
        private static bool IsSmsRecordListRtWidget(object value) {
            return value is Sms.RecordListRtWidget;
        }
    ...
    public class DebuggerEventsData {
        ...
        [Obsolete]
		public static void inicializeInstance(HttpContext context) {}

        [Obsolete]
        public static DebuggerEventsData Instance {
            get {
                throw new InvalidOperationException();
			}
		}
    ...
    public class DebuggerEvents : IHttpHandler {
        ...
        private class Clients {
            ...
            public void Remove(DebuggerEventsData client, bool useShortRequests) {
                if (useShortRequests) {
                    lock (this) {
                        var clientAndExpirationDate = new ClientAndExpirationDate() { ClientSessionEventsData = client, 
		...
		public void ProcessRequest(HttpContext context) {            
            ...
            if (useSRMParam != null){
                bool useShortRequests;
                Boolean.TryParse(useSRMParam, out useShortRequests);
                UseShortRequests = useShortRequests;
            }
        ...
        private bool? _useShortRequests = null;
        private bool UseShortRequests {
            get {
                if (_useShortRequests.HasValue) {
                    return _useShortRequests.Value;
                } else {
                    return Settings.GetBool(Settings.Configs.UseShortRequestsOnDebugger);
                }
            }
            set {
                _useShortRequests = value;
            }
        }
    }
    ...
    public class DebuggerTrace {
        ...
        private static void Log(string line, params object[] formatParams) {
            Log(String.Format(line, formatParams));
        }
        ...
        public static void Log(OSTrace.OSTraceFunc<string> msg) {
    ...
    public class DebugSession {
        ...
        public bool RequestAppliesToSession() {
            ...
            if (IsLocalConnection(requestIp) ||
                clients.Exists(c => c.LastConnectedIp == requestIp)) {
                return true;
            }
            return false;
        }
        ...
        public bool HasBreakpoint(ThreadData threadData, BreakpointId breakpointId, bool isExpressionlessWidget, BreakpointType breakpointType, string extraInfo) {
            ...
            if (stackTop != null && breakpointId != null) {
                ...
                if (breakpoints != null && breakpointType == BreakpointType.Normal &&
