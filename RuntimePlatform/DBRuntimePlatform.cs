...
namespace OutSystems.HubEdition.RuntimePlatform {
    ...
    [DoNotObfuscateType]
    public partial class DBRuntimePlatform : BaseQueryProvider<DBRuntimePlatform, DBRuntimePlatform.Qualifier> {
        ...
        [MethodImpl(MethodImplOptions.NoInlining)]
        internal void DeletePersistentLogin(Transaction tran, int userId, string terminalType) {
            Command cmd = tran.CreateCommand(
                "DELETE FROM OSSYS_PERSISTENT_LOGIN WHERE USER_ID = @USER_ID AND TERMINAL_TYPE = @TERMINAL_TYPE");
            cmd.CreateParameter("@USER_ID", DbType.Int32, userId);
            cmd.CreateParameter("@TERMINAL_TYPE", DbType.String, terminalType);
        ...
        public string GetDatabaseConfiguration(Transaction trans, string connectionName) {
            var cmd = trans.CreateCommand(
                ...
                "WHERE DBCONNECTION.NAME = @CONNECTIONNAME");
        ...
        public int GetESpaceIdbyKey(Transaction tran, ObjectKey eSpaceKey) {
            Command cmd = tran.CreateCommand("SELECT ID FROM OSSYS_ESPACE WHERE UPPER(SS_KEY)=@SS_KEY");
        ...
        public IDataReader GetPublishedEspaceInfo(Transaction tran, int espaceId) {
            string keyColumn = tran.DatabaseServices.DMLService.Identifiers.EscapeIdentifier("KEY");
            Command cmd = tran.CreateCommand(
                "SELECT OSSYS_ESPACE.ID, OSSYS_ESPACE.SS_KEY, OSSYS_ESPACE.IS_MULTITENANT, OSSYS_ESPACE.IS_USER_PROVIDER, OSSYS_ESPACE.VERSION_ID, " +
      ...
      @"SELECT COALESCE(OSSYS_CYCLIC_JOB.SCHEDULE, OSSYS_CYCLIC_JOB_SHARED.SCHEDULE) SCHEDULE
        ...
        public int CreateErrorLog(DatabaseConnection conn, ErrorLog log, int cycleSize) {
            ...
            string[] sql;
            bool isBigStack = log.Stack.Length > 2000;
            ...
            if (isBigStack == true) {
                sql = new string[] { 
                        string.Format(  
                            "INSERT INTO OSLOG_ERROR_{0} (ID, INSTANT, SESSION_ID, USER_ID, ESPACE_ID, TENANT_ID, MESSAGE, STACK, MODULE_NAME, SERVER, CYCLE, ENVIRONMENTINFORMATION) " +
                            "VALUES (@ID,@INSTANT,@SESSION_ID,@USER_ID,@ESPACE_ID,@TENANT_ID,@MESSAGE,NULL,@MODULE_NAME,@SERVER,@CYCLE, @ENVIRONMENTINFORMATION)", cycle),
                ...
                sql = new string[] {
                        string.Format(
                            "INSERT INTO OSLOG_ERROR_{0} (ID, INSTANT, SESSION_ID, USER_ID, ESPACE_ID, TENANT_ID, MESSAGE, STACK, MODULE_NAME, SERVER, CYCLE, ENVIRONMENTINFORMATION) " +
                            "VALUES (@ID,@INSTANT,@SESSION_ID,@USER_ID,@ESPACE_ID,@TENANT_ID,@MESSAGE,@STACK,@MODULE_NAME,@SERVER,@CYCLE,@ENVIRONMENTINFORMATION)", cycle)
                    };
            }
        ...
        private static Command CreateErrorLogParameters(Command cmd, ErrorLog log, int cycle, bool isBigStack, int index) {
            ...
            cmd.CreateParameter("@ID", DbType.String, RuntimePlatformUtils.Trunc(RuntimePlatformUtils.NoNull(log.Id), 50));
            cmd.CreateParameter("@INSTANT", DbType.DateTime, log.Instant);
            cmd.CreateParameter("@SESSION_ID", DbType.String, RuntimePlatformUtils.Trunc(RuntimePlatformUtils.NoNull(log.SessionId), 50));
            ...
            cmd.CreateParameter("@MESSAGE", DbType.String, RuntimePlatformUtils.Trunc(RuntimePlatformUtils.NoNull(log.Message), 2000));
                    cmd.CreateParameter("@MODULE_NAME", DbType.String, RuntimePlatformUtils.Trunc(RuntimePlatformUtils.NoNull(log.ModuleName), 15));
                    cmd.CreateParameter("@SERVER", DbType.String, RuntimePlatformUtils.Trunc(RuntimePlatformUtils.NoNull(log.Server), 50));
                    cmd.CreateParameter("@CYCLE", DbType.Int32, cycle);
                    cmd.CreateParameter("@ENVIRONMENTINFORMATION", DbType.String, RuntimePlatformUtils.Trunc(RuntimePlatformUtils.NoNull(log.EnvironmentInformation), 2000)); 
                } else { 
                    // index = 1: second statement has only @Stack and @Id parameters
                    cmd.CreateParameter("@ID", DbType.String, RuntimePlatformUtils.Trunc(RuntimePlatformUtils.NoNull(log.Id), 50));
            cmd.CreateParameter("@STACK", log.Stack);
                }
            } else {
        ...
        public int CreateGeneralLog(DatabaseConnection conn, GeneralLog log, int cycleSize) {
            ...
            using (var cmd = conn.CreateCommand(string.Format(
                "INSERT INTO OSLOG_GENERAL_{0} (INSTANT, SESSION_ID, USER_ID, ESPACE_ID, TENANT_ID, MESSAGE, MESSAGE_TYPE, MODULE_NAME, ERROR_ID, CYCLE) " +
                "VALUES (@INSTANT,@SESSION_ID,@USER_ID,@ESPACE_ID,@TENANT_ID,@MESSAGE,@MESSAGE_TYPE,@MODULE_NAME,@ERROR_ID,@CYCLE)", cycle))) {
                cmd.CreateParameter("@INSTANT", DbType.DateTime, log.Instant);
                cmd.CreateParameter("@SESSION_ID", DbType.String, RuntimePlatformUtils.Trunc(RuntimePlatformUtils.NoNull(log.SessionId), 50));
                cmd.CreateParameter("@USER_ID", DbType.Int32, log.UserId);
                cmd.CreateParameter("@ESPACE_ID", DbType.Int32, log.EspaceId);
                cmd.CreateParameter("@TENANT_ID", DbType.Int32, log.TenantId);
                cmd.CreateParameter("@MESSAGE", DbType.String, RuntimePlatformUtils.Trunc(RuntimePlatformUtils.NoNull(log.Message), 2000));
                cmd.CreateParameter("@MESSAGE_TYPE", DbType.String, RuntimePlatformUtils.Trunc(RuntimePlatformUtils.NoNull(log.MessageType), 10));
                cmd.CreateParameter("@MODULE_NAME", DbType.String, RuntimePlatformUtils.Trunc(RuntimePlatformUtils.NoNull(log.ModuleName), 15));
        ...
        public int CreateScreenLog(DatabaseConnection conn, ScreenLog log, int cycleSize) {
            int cycle = RuntimeLogger.CalculateIndex(log.Instant, cycleSize);
            using (var cmd = conn.CreateCommand(string.Format(
                "INSERT INTO OSLOG_SCREEN_{0} (INSTANT, SESSION_ID, USER_ID, ESPACE_ID, TENANT_ID, SCREEN, DURATION, MSISDN, SCREEN_TYPE, ACCESS_MODE, EXECUTED_BY, CYCLE, SESSION_BYTES, SESSION_REQUESTS, VIEWSTATE_BYTES) " +
                "VALUES (@INSTANT,@SESSION_ID,@USER_ID,@ESPACE_ID,@TENANT_ID,@SCREEN,@DURATION,@MSISDN,@SCREEN_TYPE,@ACCESS_MODE,@EXECUTED_BY,@CYCLE,@SESSION_BYTES,@SESSION_REQUESTS,@VIEWSTATE_BYTES)", cycle))) {
                cmd.CreateParameter("@INSTANT", DbType.DateTime, log.Instant);
                cmd.CreateParameter("@SESSION_ID", DbType.String, RuntimePlatformUtils.Trunc(RuntimePlatformUtils.NoNull(log.SessionId), 50));
                cmd.CreateParameter("@USER_ID", DbType.Int32, log.UserId);
                cmd.CreateParameter("@ESPACE_ID", DbType.Int32, log.EspaceId);
                cmd.CreateParameter("@TENANT_ID", DbType.Int32, log.TenantId);
                cmd.CreateParameter("@SCREEN", DbType.String, RuntimePlatformUtils.Trunc(RuntimePlatformUtils.NoNull(log.Screen), 50));
                cmd.CreateParameter("@DURATION", DbType.Int32, log.Duration);
                cmd.CreateParameter("@MSISDN", DbType.String, RuntimePlatformUtils.Trunc(RuntimePlatformUtils.NoNull(log.Msisdn), 20));
                cmd.CreateParameter("@SCREEN_TYPE", DbType.String, RuntimePlatformUtils.Trunc(RuntimePlatformUtils.NoNull(log.ScreenType), 10));
                cmd.CreateParameter("@ACCESS_MODE", DbType.String, RuntimePlatformUtils.Trunc(RuntimePlatformUtils.NoNull(log.AccessMode), 10));
        ...
        public int CreateExtensionLog(DatabaseConnection conn, ExtensionLog log, int cycleSize) {
            int cycle = RuntimeLogger.CalculateIndex(log.Instant, cycleSize);
            using (var cmd = conn.CreateCommand(string.Format(
                "INSERT INTO OSLOG_EXTENSION_{0} (INSTANT, ACTION_NAME, SESSION_ID, USER_ID, ESPACE_ID, TENANT_ID, EXTENSION_ID, DURATION, EXECUTED_BY, ERROR_ID, CYCLE) " +
                "VALUES (@INSTANT,@ACTION_NAME,@SESSION_ID,@USER_ID,@ESPACE_ID,@TENANT_ID,@EXTENSION_ID,@DURATION,@EXECUTED_BY,@ERROR_ID,@CYCLE)", cycle))) {
                cmd.CreateParameter("@INSTANT", DbType.DateTime, log.Instant);
                cmd.CreateParameter("@SESSION_ID", DbType.String, RuntimePlatformUtils.Trunc(RuntimePlatformUtils.NoNull(log.SessionId), 50));
                cmd.CreateParameter("@USER_ID", DbType.Int32, log.UserId);
                cmd.CreateParameter("@ESPACE_ID", DbType.Int32, log.EspaceId);
                ...
                cmd.CreateParameter("@ACTION_NAME", DbType.String, RuntimePlatformUtils.Trunc(RuntimePlatformUtils.NoNull(log.Action_Name), 50));
                cmd.CreateParameter("@DURATION", DbType.Int32, log.Duration);
                cmd.CreateParameter("@EXECUTED_BY", DbType.String, RuntimePlatformUtils.Trunc(RuntimePlatformUtils.NoNull(log.ExecutedBy), 50));
        ...
        public int CreateCyclicJobLog(DatabaseConnection conn, CyclicJobLog log, int cycleSize) {
            int cycle = RuntimeLogger.CalculateIndex(log.Instant, cycleSize);
            using (var cmd = conn.CreateCommand(string.Format(
                "INSERT INTO OSLOG_CYCLIC_JOB_{0} (INSTANT, ESPACE_ID, TENANT_ID, DURATION, EXECUTED_BY, CYCLIC_JOB_KEY, ERROR_ID, SHOULD_HAVE_RUN_AT, NEXT_RUN, CYCLE) " +
                "VALUES (@INSTANT,@ESPACE_ID,@TENANT_ID,@DURATION,@EXECUTED_BY,@CYCLIC_JOB_KEY,@ERROR_ID,@SHOULD_HAVE_RUN_AT,@NEXT_RUN,@CYCLE)", cycle))) {
                cmd.CreateParameter("@INSTANT", DbType.DateTime, log.Instant);
                cmd.CreateParameter("@ESPACE_ID", DbType.Int32, log.EspaceId);
                cmd.CreateParameter("@TENANT_ID", DbType.Int32, log.TenantId);
                cmd.CreateParameter("@DURATION", DbType.Int32, log.Duration);
        ...
        public static int CreateIntegrationLog(DatabaseConnection conn, IntegrationLog log, int cycleSize) {
            int cycle = RuntimeLogger.CalculateIndex(log.Instant, cycleSize);
            using (var cmd = conn.CreateCommand(string.Format(
                "INSERT INTO OSLOG_INTEGRATION_{0} (ID, INSTANT, DURATION, SOURCE, ENDPOINT, ACTION, TYPE, ESPACE_ID, TENANT_ID, ERROR_ID, EXECUTED_BY, IS_EXPOSE, CYCLE) " +
                "VALUES (@ID, @INSTANT, @DURATION, @SOURCE, @ENDPOINT, @ACTION, @TYPE, @ESPACE_ID, @TENANT_ID, @ERROR_ID, @EXECUTED_BY, @IS_EXPOSE, @CYCLE)", cycle))) {
                cmd.CreateParameter("@ID", DbType.String, RuntimePlatformUtils.Trunc(RuntimePlatformUtils.NoNull(log.Id), 50));
                cmd.CreateParameter("@INSTANT", DbType.DateTime, log.Instant);
                cmd.CreateParameter("@DURATION", DbType.Int32, log.Duration);
                cmd.CreateParameter("@SOURCE", DbType.String, RuntimePlatformUtils.Trunc(RuntimePlatformUtils.NoNull(log.Source), 15));
                cmd.CreateParameter("@ENDPOINT", DbType.String, RuntimePlatformUtils.Trunc(RuntimePlatformUtils.NoNull(log.Endpoint), 1000));
                cmd.CreateParameter("@ACTION", DbType.String, RuntimePlatformUtils.Trunc(RuntimePlatformUtils.NoNull(log.Action), 100));
                cmd.CreateParameter("@TYPE", DbType.String, RuntimePlatformUtils.Trunc(RuntimePlatformUtils.NoNull(log.Type), 50));
                cmd.CreateParameter("@ESPACE_ID", DbType.Int32, log.EspaceId);
                cmd.CreateParameter("@TENANT_ID", DbType.Int32, log.TenantId);
                cmd.CreateParameter("@ERROR_ID", DbType.String, RuntimePlatformUtils.Trunc(RuntimePlatformUtils.NoNull(log.ErrorId), 50));
                cmd.CreateParameter("@EXECUTED_BY", DbType.String, RuntimePlatformUtils.Trunc(RuntimePlatformUtils.NoNull(log.ExecutedBy), 10));
        ...
        public static int CreateIntDetailLog(DatabaseConnection conn, IntDetailLog log, int cycleSize) {
            ...
            using (var cmd = conn.CreateCommand(string.Format(
                ...
                cmd.CreateParameter("@TENANT_ID", DbType.Int32, log.TenantId);
                cmd.CreateParameter("@MESSAGE", DbType.String, RuntimePlatformUtils.Trunc(RuntimePlatformUtils.NoNull(log.Message), 2000));
                cmd.CreateParameter("@DETAIL", DbType.String, log.Detail);
                cmd.CreateParameter("@DETAILLABEL", DbType.String, log.DetailLabel);
                cmd.CreateParameter("@CYCLE", DbType.Int32, cycle);                
                return cmd.ExecuteNonQuery();
            }
        }
        ...
        [MethodImpl(MethodImplOptions.NoInlining)]
        public IDataReader GetEntitiesPerExtension(Transaction tran) {
            Command cmd = tran.CreateCommand(
                "SELECT EX.SS_KEY, EX.NAME, COUNT(1) " +
                "FROM OSSYS_EXTENSION EX " +
                "INNER JOIN OSSYS_ENTITY EN ON EX.ID = EN.EXTENSION_ID " +
                "AND EN.IS_ACTIVE=1 AND EX.IS_ACTIVE=1 " +
                "GROUP BY EX.SS_KEY, EX.NAME");
            return cmd.ExecuteReader();
        }
