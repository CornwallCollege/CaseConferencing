...
namespace OutSystems.HubEdition {
    ...
    public interface ICompiler {
        ...
        HEMessageArrayList CompileOmlWithEmptyProxies(ICompilerContext context, string espaceName, int espaceVersionId, bool debugMode, bool withoutImpactAnalysis, string uniqueId, string username, bool ssForceFirstLoad);
        ...
        HEMessageArrayList MakeOffline(ICompilerContext context, string espaceName);
        ...
        PublishExtensionOutput PublishExtension(ICompilerContext context, int extensionVersionId, int developerId, bool switchPublishedVersion);

        PublishExtensionOutput PublishExtension_SwitchPublishedVersion(ICompilerContext context, int extensionVersionId, int developerId);
        ...
        ICompilerBoolOutput SwitchEspacePublishedVersion(ICompilerContext context, string espaceName, int eSpaceVersionId, string uniqueId);
        ...
        int CreateNewESpace(ICompilerContext context, string name, bool isMultiTenant, string eSpaceKey);
