...
namespace OutSystems.HubEdition.RuntimePlatform {    
    ...
    public class OSJSONResponse
    {
        ...
        public override string ToString() {
			...
			if (outer.Count > 0)
				ajaxResponse.Add(outerValue, new JSONObjectCollection(outer));
			if (list.Count > 0)
				ajaxResponse.Add(listValue, new JSONObjectCollection(list));
			if (hidden.Count > 0)
				ajaxResponse.Add(hiddenValue, new JSONObjectCollection(hidden));
			if (js.Count > 0)
