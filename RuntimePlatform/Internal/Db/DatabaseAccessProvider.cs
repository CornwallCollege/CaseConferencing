...
namespace OutSystems.Internal.Db {
    ...
    public class DatabaseAccessProvider<TDatabaseServices>: IDatabaseAccessProvider where TDatabaseServices: IDatabaseServices {
        ...
        public virtual Transaction GetRequestTransaction() {
            ...
            if (System.Web.HttpContext.Current == null) {
                ...
                return new ManagedTransaction(TransactionManager, TransactionManager.GetRequestTransaction());
            }
        }
        ...
        public virtual Transaction GetCommitableTransaction() {
            return new PrivateManagedTransaction(TransactionManager, TransactionManager.GetCommitableTransaction());
        }
        ...
        public virtual Transaction GetReadOnlyTransaction() {
            ...
            if (System.Web.HttpContext.Current == null) {
                ...
                return new ManagedTransaction(TransactionManager, TransactionManager.GetReadOnlyTransaction());
            }
        }
        ...
        public void ExecuteQuery<T>(Command cmd, GenericRecordList<T> rl, string description, bool transformParameters, bool skipLog) where T : ITypedRecord<T> {
            rl.Reader = cmd.ExecuteReader(description, true, transformParameters, skipLog);
        }
        ...
        public override bool Equals(object obj) {
            var other = obj as DatabaseAccessProvider<TDatabaseServices>;
            return (other != null) && other.DatabaseServices.DatabaseConfiguration.Equals(DatabaseServices.DatabaseConfiguration);
        }
