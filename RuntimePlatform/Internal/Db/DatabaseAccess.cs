...
namespace OutSystems.Internal.Db {
    ...
    public class DatabaseAccess {
        ...
        private static readonly SynchronizationContext locker = new SynchronizationContext();

        private static int? queryTimeout;
        private static readonly object queryTimeoutLockObject = new object();

        private static int? introspectionQueryTimeout;
        private static readonly object introspectionQueryTimeoutLockObject = new object(); 

        private static int queryThreshold;
        private static bool isQueryThresholdLoaded;
            ...
            get {
                if (integrationDatabasesPluginProvider == null) {
                    lock (typeof(DatabaseAccess)) {
                        if (integrationDatabasesPluginProvider == null) {
                            integrationDatabasesPluginProvider = new DatabasePluginProvider<IDatabaseProvider>(GetPluginPaths());
                        }
                    }
                }
        ...
        private static DatabasePluginProvider<IPlatformDatabaseProvider> PlatformDatabasePluginProvider {
            get {
                if (platformDatabasePluginProvider == null) {
                    lock (typeof(DatabaseAccess)) {
                        if (platformDatabasePluginProvider == null) {
                            platformDatabasePluginProvider = new DatabasePluginProvider<IPlatformDatabaseProvider>(GetPluginPaths());
                        }
                    }
                }
        ...
        /// </summary>
        private readonly IDictionary<string, DatabaseAccessProvider<IDatabaseServices>> dbConnectionProviders 
        ...
        private DatabaseAccess(bool initialize) {
            if (initialize) {
                ...
                systemProvider = CreatePlatformDatabaseAccessProvider(PlatformDatabasePluginProvider, source, DatabaseSettingsSerialization.User.Runtime);
                sessionProvider = CreatePlatformDatabaseAccessProvider(PlatformDatabasePluginProvider, source, DatabaseSettingsSerialization.User.Session);
                loggingProvider = CreatePlatformDatabaseAccessProvider(PlatformDatabasePluginProvider, source, DatabaseSettingsSerialization.User.Log);
            }
        }
            ...
            get {
                ...
                HttpContext context = HttpContext.Current;
                    if (context.Items[SINGLETON_CONTEXT] == null) {
                        lock (context)
                            if (context.Items[SINGLETON_CONTEXT] == null) {
                                context.Items[SINGLETON_CONTEXT] = new DatabaseAccess(/*initialize*/true);
                            }
                    }
        ...
        public static void ResetConfiguration() {
            if (IsInitialized()) {
                ...
                current.SystemProvider = CreatePlatformDatabaseAccessProvider(
                    DatabaseAccess.PlatformDatabasePluginProvider,
                    AccessRequester,
        ...
        protected internal static IRuntimeDatabaseConfiguration LoadConfigurationForESpace(int eSpaceId) {
            using (var trans = ForSystemDatabase.GetCommitableTransaction()) {
                ...
                var conf = RuntimeDatabaseConfigurations.For(
                    DatabaseAccess.CurrentPlatformDatabasePluginProvider,
                    AccessRequester,
                    DatabaseSettingsSerialization.User.Runtime);
                ...
                lock (providersByIdentifier) {
                    if (!providersByIdentifier.TryGetValue(providerIdentifier, out provider)) {
                        ...
                        if (manager == null && !transactionManagersByIdentifier.TryGetValue(managerIdentifier, out manager)) {
                            var services = CurrentPlatformDatabasePluginProvider
                        ...
                        var dapServices = CurrentPlatformDatabasePluginProvider
                                            .GetImplementation(configurationForDatabase.ProviderKey())
                                            .GetPlatformDatabaseServices(configurationForDatabase);
        ...
        protected static DatabaseAccessProvider<IPlatformDatabaseServices> CreatePlatformDatabaseAccessProvider(
                DatabasePluginProvider<IPlatformDatabaseProvider> pluginProvider, DatabaseSettingsSerialization.Source source, 
        ...
        private static IEnumerable<DirectoryInfo> GetPluginPaths() {
            if (HttpContext.Current == null) {
                DirectoryInfo dirFromSettings = new DirectoryInfo(Path.Combine(Settings.Get(Settings.Configs.PluginDirectory), "database"));
                if (dirFromSettings.Exists) {
                    yield return dirFromSettings;
                }
            }
            DirectoryInfo binDir = new DirectoryInfo(Path.Combine(AppDomain.CurrentDomain.BaseDirectory, RuntimePlatformUtils.GetLibDirectoryName()));
            if (binDir.Exists) {
                yield return binDir;
            }
        }
        ...
        protected static DatabasePluginProvider<IPlatformDatabaseProvider> CurrentPlatformDatabasePluginProvider { 
            get { 
                return DatabaseAccess.PlatformDatabasePluginProvider;
            } 
        }
        ...
        public static int IntrospectionQueryTimeout {
            get {
                if (!introspectionQueryTimeout.HasValue) {
                    lock (introspectionQueryTimeoutLockObject) {
                        if (!introspectionQueryTimeout.HasValue) {
                            int timeoutValue;
                ...
                return introspectionQueryTimeout.Value;
            }
            set {
