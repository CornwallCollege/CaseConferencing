...
namespace OutSystems.HubEdition.RuntimePlatform {
    public abstract class StaticEntityRuntime {
        ...
        private bool cacheControl = false;
        ...
        private void InvalidateRecordsCache(string key, Object val, CacheItemRemovedReason reason) { 
            lock (_recordsMetaByKey) {
                if (cacheControl) {
                    cacheControl = false;
                }
