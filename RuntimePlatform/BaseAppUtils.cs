...
namespace OutSystems.HubEdition.RuntimePlatform {
    ...
    public abstract class BaseAppUtils {
        ...
        public static bool UrlAttributeMustBeEncoded(System.Web.HttpRequest req) {
            bool res = false;
            if (req.Browser is System.Web.Mobile.MobileCapabilities) {
                string prefRendType = ((System.Web.Mobile.MobileCapabilities)req.Browser).PreferredRenderingType;
        ...
        public static string ReplaceEntityReferences(string sql, Dictionary<string,string> entitiesTablenames) {
            return new ReplaceEntities(delegate(string entName) {
        ...
        public abstract string getImagePath(bool forInternalAccess, bool includeSessionIdIfNeeded, string nameOverride);
