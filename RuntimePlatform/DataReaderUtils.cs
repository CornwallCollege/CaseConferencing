...
namespace OutSystems.HubEdition.RuntimePlatform {
    ...
    public static class DataReaderUtils {
        ...
        public static int ReadInteger(this IDataReader reader, int i, string columnName, int defaultValue) {
            return ReadWrapper(reader, i, columnName, (column, r, index) => {
                ...
                if (column == System.DBNull.Value || column is int) {
                    return (column != System.DBNull.Value ? (int)column : defaultValue);
                } else {
        ...
        [DebuggerNonUserCode]
        public static string ReadTextEntityReference(this IDataReader reader, int i, string columnName) {
            return ReadTextEntityReference(reader, i, columnName, string.Empty);
        }

        [DebuggerNonUserCode]
        public static string ReadTextEntityReference(this IDataReader reader, int i, string columnName, string defaultValue) {
            return reader.ReadString(i, columnName, defaultValue);
        }
