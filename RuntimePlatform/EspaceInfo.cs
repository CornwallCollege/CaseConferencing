...
namespace OutSystems.HubEdition.RuntimePlatform {
    ...
    /// </summary>
    public class EspaceInfo {

        private AppInfo _appInfo;
        private readonly int _espaceId;
        private IDictionary<int, EspaceTenantInfo> _tenants = new Dictionary<int, EspaceTenantInfo>();
        ...
        public void ClearEspaceInfo() {
            _appInfo = null;
            if (_tenants != null) {
                foreach (EspaceTenantInfo tenant in _tenants.Values) {
                    tenant.ClearEspaceTenantInfo();
                }
                _tenants = null;
            }
        }
