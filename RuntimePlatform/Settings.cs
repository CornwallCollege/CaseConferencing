...
namespace OutSystems.HubEdition.RuntimePlatform {
    public class Settings {
        ...
        public class Configs {
            ...
            public const string UpgradeSettingsEncryption = "OutSystems.HubEdition.UpgradeSettingsEncryption";
            ...
            public const string Compiler_UseAntiXSSHTMLEncoder = "Compiler.UseAntiXSSHTMLEncoder";
            ...
            public const string JavaCompilerService_Stubs = "CompilerService.CompilerServiceStubs";
            ...
            public const string Compiler_Partial1CPTestsPath = "Compiler.Partial1CPTestsPath";
            ...
            public const string NodeJs_Path = "NodeJs.Path";
            ...
            public const string Sandbox_EmailQuota = "Sandbox.Email.Quota";
            public const string Sandbox_EmailQuotaSMTP = "Sandbox.Email.QuotaSMTP";
            public const string Sandbox_EmailQuotaUser = "Sandbox.Email.QuotaUser";
            public const string Sandbox_LicensingCycleInterval = "Sandbox.Licensing.CycleInterval";
        ...
        private static string[] nodeSettings = new string[] {
                                                            ...
                                                            Configs.JavaCompilerService_Stubs,
            ...
            if (defaultValues.Count == 0) {
                lock (defaultValues) {
                    if (defaultValues.Count == 0) {
                        ...
                        defaultValues.Add(Configs.PasswordUpgradeOnLogin, "false");
                        defaultValues.Add(Configs.UpgradeSettingsEncryption, "false");
                        ...
                        defaultValues.Add(Configs.Oracle_DDL_LOCK_TIMEOUT_InSeconds, "0");  // -1 not defined, 0 do not set DDL_LOCK_TIMEOUT, other use the value in Seconds
                        ...
                        defaultValues.Add(Configs.Sandbox_EmailQuota, "10");
                        defaultValues.Add(Configs.Sandbox_EmailQuotaSMTP, "smtp.gmail.com");
                        defaultValues.Add(Configs.Sandbox_EmailQuotaUser, "noreply@outsystems.net");
                        defaultValues.Add(Configs.Sandbox_LicensingCycleInterval, "5");
                        defaultValues.Add(Configs.Sandbox_LicensingFeatureIntervalMultiplicationFactor, "5");
                        ...
                        defaultValues.Add(Configs.Compiler_DotNetTargetFramework, "4.5");
                        defaultValues.Add(Configs.Compiler_DotNetCompilerExtraFlags, string.Empty);
                        defaultValues.Add(Configs.Compiler_CssCompilationStrategy, "0"); // TODO JMN turn CSS optimization feature on -> 1
                        defaultValues.Add(Configs.Compiler_UseAntiXSSHTMLEncoder, "false");
        ...
        private static readonly string[] globalSettings = new string[] {
                                                                           ...
                                                                           Configs.Sandbox_EmailQuota,
                                                                           Configs.Sandbox_EmailQuotaSMTP,
                                                                           Configs.Sandbox_EmailQuotaUser,
                                                                           Configs.Sandbox_LicensingCycleInterval, 
                                                                           Configs.Sandbox_LicensingFeatureIntervalMultiplicationFactor,
        ...
        private static readonly string[] unitTestSettings = new string[] {
                                                                           ...
                                                                           Configs.Compiler_Partial1CPTestsPath,
        ...
        public static bool isInitalizedPersistentSettings() {
            try {
                ...
                return osversion != null && osversion != string.Empty;
            } catch (SqlException) {
            ...
            lock (typeof(Settings)) {
                ...
                try {
                    ...
                    foreach (var entry in globalEntries) {
                        if (isEncryptedSetting(entry.First)) {
                    ...
                    foreach (var entry in globalEntries) {
                        if (!isVolatileSetting(entry.First)) {
        ...
        private static string GetParameter(string name, bool isNodeSetting, Transaction transaction) {
            ...
            int retries = 3;
            for (; ; ) {
                Transaction tran = (transaction == null ? DatabaseAccess.ForSystemDatabase.GetCommitableTransaction() : transaction);
                try {
