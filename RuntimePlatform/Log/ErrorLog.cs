...
namespace OutSystems.HubEdition.RuntimePlatform.Log {
    ...
    public class ErrorLog : ICloneable {
        ...
        public const int MAX_STACK_SIZE = 4000;
        ...
        private static string StaticWriteWithId(
            ...
            string moduleName) {
            ErrorLog log = new ErrorLog();
            log.Write(id, instant, sessionId, espaceId, tenantId, userId, message, stack, environmentInformation, moduleName, false);
            return log.ErrorId;
        }
        ...
        private void Write(
            ...
            RuntimeLogger.Log(this, forceSynchronous);
        }
        ...
        private static string LogApplicationError(DateTime instant, string message, Exception excep, AppInfo info, HeContext context, string moduleName,
            ...
            try {
                ...
                try {
                    ...
                    ErrorLog.StaticWriteWithId(errorId, instant, sessionid, espaceid, tenantid, userid, message, stack.ToString(), environmentInformation, moduleName);
                }
