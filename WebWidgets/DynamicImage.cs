...
namespace OutSystems.HubEdition.WebWidgets {
    ...
    public sealed class DynamicImage : ViewStateSpecializations.ViewStateLessImage, IBreakPointControl, IAjaxHandler, IAjaxClickEvent, IGridWidget, IOSControl {
		...
		private string CalculateDatabaseImageUrl() {
            string entityDetails = SecureConfidentialInformationEncryption.EncryptWithAlgorithm(Entity + "/" + Attribute + "/" + EntityId, 
                SecureConfidentialInformationEncryption.FixedKeyRC4.Instance);

            entityDetails = entityDetails.Replace("+", "-").Replace("/", "_");    /* Replace invalid URL chars */
            return Path + "_image.aspx/"+ entityDetails + "/" + Source;
		}
		#endregion
