...
namespace OutSystems.RuntimeCommon {
    ...
    public static class Constants {
        ...
        public static readonly ObjectKey EnterpriseManagerESpaceKey = ObjectKey.NewKey(new Guid("3136AC21-3073-405E-85DC-8FBC1E819BD9"));
        public static readonly ObjectKey EPATaskboxESpaceKey = ObjectKey.Parse("460089c7-af3d-437a-ab33-a93fa9d39bab");

        public static readonly ObjectKey AdminEmailSitePropertyKey = ObjectKey.NewKey(new Guid("f0B30515-DB99-34C5-0738-23B6598E51CB"));

        public static readonly GlobalObjectKey EpaTaskboxSeenActivityKey = new GlobalObjectKey(EPATaskboxESpaceKey,
            ObjectKey.NewKey(new Guid("d67cdd4a-cbc6-4acd-a1c5-42032c1d57ac")));
        ...
        public const string SystemDatabaseLogicalName = "(Main)";
