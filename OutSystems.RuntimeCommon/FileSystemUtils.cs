...
namespace OutSystems.RuntimeCommon {
    ...
    public static class FileSystemUtils {
        ...
        private static Regex temporaryFileRegex;

        public static bool IsTemporary(OutSystemsPlatform platform, string fileName) {
            if (temporaryFileRegex == null) {
                temporaryFileRegex = new Regex("(.*)\\.tmp", RegexOptions.IgnoreCase | RegexOptions.Compiled);
            }
            return temporaryFileRegex.IsMatch(fileName);
        }
        ...
        public static string GetTemporaryDirectory() {
            ...
            if (!directory.EndsWith(FileSystemUtils.PathSeparator) && !directory.EndsWith("\\") && !directory.EndsWith("/")) {
                directory += FileSystemUtils.PathSeparator;
            }
            return directory;
        }
